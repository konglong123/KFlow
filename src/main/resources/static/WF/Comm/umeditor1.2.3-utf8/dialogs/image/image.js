        ...
        Base = {
            ...
            callback: function (editor, $w, url, state) {
                ...
                if (state == "SUCCESS") {
                    ...
                    if (plant == "CCFlow")
                        url = localhostPaht + "/" + url.substring(url.indexOf("DataUser"));
                    else
                        url = localhostPaht + projectName + "/" + url.substring(url.indexOf("DataUser"));
    ...
    * */
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<form id="imageform" class="edui-image-form" method="post" enctype="multipart/form-data" target="up">' +
        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate(".edui-image-file", "change", function (e) {
                ...
                $('<iframe name="up"  style="display: none" id="richFrame"></iframe>').insertBefore(me.dialog);

                $("#richFrame").on('load', function () {
                ...
                var richurl = me.editor.options.imageUrl;

                richurl = richurl + (richurl.indexOf("?") == -1 ? "?" : "&") + "editorid=" + me.editor.id; //初始form提交地址;
