                ...
                switch (node.getHisOutTimeDeal())
                {
                    ...
                    case AutoJumpToSpecNode: //跳转到指定的节点.
                        try
                        {
                            ...
                            //设置默认同意.
                            BP.WF.Dev2Interface.WriteTrackWorkCheck(jumpToNode.getFK_Flow(), node.getNodeID(), workid, 0,
                                "同意（预期自动审批）", null);
                    ...
                    case AutoShiftToSpecUser: //走动移交给.
                        ...
                        try
                        {
                            BP.WF.Dev2Interface.Node_Shift(fk_flow, fk_node, workid, 0, empShift.getNo(),
                                "流程节点已经逾期,系统自动移交");
