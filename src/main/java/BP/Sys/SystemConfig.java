...
public class SystemConfig {
	...
	public static String getPathOfData() {
		//String path=getPathOfWebApp()+File.separator+SystemConfig.getAppSettings()+.get("DataDirPath").toString()+File.separator;
		Hashtable<String, Object> temp=SystemConfig.getAppSettings();
		String path=temp.get("ProjectPath").toString()+"/"+temp.get("DataDirPath").toString()+"/Data";
		BP.DA.Log.DebugWriteInfo(path);
		return path;
	}
	...
	public static String getPathOfWebApp() {
		String path=SystemConfig.getAppSettings().get("ProjectPath").toString();
		return path;
