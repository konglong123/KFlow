package com.kong.kflowweb.Controller;

import com.kong.kflowweb.WebServiceImp.LocalWS;
...
/**
	...
	public String SendWorkZHZG(long workid, int toNodeID, String toEmps, String userNo) throws Exception {
		...
		String flowNo=com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnString(sql);
		com.kong.kflowweb.BP.WF.SendReturnObjs objs = com.kong.kflowweb.BP.WF.Dev2Interface.Node_SendWork(flowNo, workid, null, toNodeID, toEmps);
		...
		DataTable dt = com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(sql2);
   ...
   public String Node_ReturnWork(long workID, int returnToNodeID, String returnMsg, String userNo) throws Exception {
	  com.kong.kflowweb.BP.WF.Dev2Interface.Port_Login(userNo);
	  GenerWorkFlow gwf=new GenerWorkFlow(workID);
      return com.kong.kflowweb.BP.WF.Dev2Interface.Node_ReturnWork(gwf.getFK_Flow(), workID, gwf.getFID(), gwf.getFK_Node(), returnToNodeID,null, returnMsg,false);
