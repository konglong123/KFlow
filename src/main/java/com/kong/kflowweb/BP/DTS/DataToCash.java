...
public class DataToCash extends DataIOEn
{
	...
	public void Do() throws Exception
	{
		...
		for (DataRow dr : dt.Rows)
		{
			...
			com.kong.kflowweb.BP.Sys.SysEnums ses = new com.kong.kflowweb.BP.Sys.SysEnums(str);
		}
		 ...
		 * ClassFactory.GetObjects("com.kong.kflowweb.BP.En.Entities"); for (Entities ens : al)
		 */
		java.util.ArrayList<Entities> al = ClassFactory
				.GetObjects("com.kong.kflowweb.BP.En.Entities");
		for (Entities ens : al)
		{
			Depositary where;
			try
		...
		// 把xml 数据放进cash.
		/*
		 * warning al = ClassFactory.GetObjects("com.kong.kflowweb.BP.XML.XmlEns"); for
		 * (com.kong.kflowweb.BP.XML.XmlEns ens : al)
		 */
		java.util.ArrayList<XmlEns> als = ClassFactory
				.GetObjects("com.kong.kflowweb.BP.XML.XmlEns");
		for (XmlEns ens : als)
		{
			try
			{
