...
/** 
 报表
*/
public class GERpt extends com.kong.kflowweb.BP.En.EntityOID
{
	...
	*/
	...
	public final void setWFState(WFState value)
	{
		...
		{
			case Complete:
				SetValByKey(com.kong.kflowweb.BP.WF.GenerWorkFlowAttr.WFSta, WFSta.Complete.getValue());
				break;
			case Delete:
			case Blank:
				SetValByKey(com.kong.kflowweb.BP.WF.GenerWorkFlowAttr.WFSta, WFSta.Etc.getValue());
				break;
			default:
				SetValByKey(com.kong.kflowweb.BP.WF.GenerWorkFlowAttr.WFSta, WFSta.Runing.getValue());
				break;
		}
	...
	*/
	...
	@Override
	public void Copy(com.kong.kflowweb.BP.DA.DataRow dr)
	{
