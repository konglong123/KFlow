...
import com.kong.kflowweb.BP.WF.Template.Directions;
...
import com.kong.kflowweb.BP.WF.Template.LabNotes;
...
public class WF_Admin_CCBPMDesigner2018 extends WebContralBase
{
	...
	*/
	...
	{
		//让admin登录
		if (DotNetToJavaStringHelper.isNullOrEmpty(com.kong.kflowweb.BP.Web.WebUser.getNoOfRel())==true)
		{
	...
	*/
	public final String Login_Init() throws Exception
	{
         ...
         ////让admin登录
         //if (string.IsNullOrEmpty(com.kong.kflowweb.BP.Web.WebUser.No) || com.kong.kflowweb.BP.Web.WebUser.IsAdmin == false)
         //    return "url@Login.htm?DoType=Logout";
	...
	public final String Node_ChangeRunModel() throws Exception
	{
	   ...
	   public String GetTreeJson_AdminMenu() throws Exception
       {
		   AdminMenus menus = new AdminMenus();
			...
			return com.kong.kflowweb.BP.Tools.Json.DataTableToJson(newMenus.ToDataTable(), true);
       }
