...
public class AthUnReadLog extends EntityMyPK {
	...
	public UAC getHisUAC() throws Exception {
		...
		com.kong.kflowweb.BP.En.UAC uac = new com.kong.kflowweb.BP.En.UAC();
		uac.Readonly();
		return uac;
	...
	public Map getEnMap() {
		...
		// 流程基础数据。
		map.AddMyPK();
		map.AddDDLEntities(GenerWorkFlowAttr.FK_Dept, null, "部门", new com.kong.kflowweb.BP.WF.Port.Depts(), false);
		...
		map.AddDDLEntities(GenerWorkFlowAttr.FK_NY, null, "年月", new com.kong.kflowweb.BP.Pub.NYs(), false);
