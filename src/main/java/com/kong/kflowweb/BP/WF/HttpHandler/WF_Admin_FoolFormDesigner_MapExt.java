...
import com.kong.kflowweb.BP.Sys.PopValFormat;
import com.kong.kflowweb.BP.Sys.PopValSelectModel;
...
public class WF_Admin_FoolFormDesigner_MapExt extends WebContralBase {
	...
	*/
	...
	public String RegularExpression_Init() {
		...
		com.kong.kflowweb.BP.Sys.XML.RegularExpressions res = new com.kong.kflowweb.BP.Sys.XML.RegularExpressions();
		res.Retrieve("ForCtrl", "TB");
		DataTable myDT = res.ToDataTable();
		myDT.TableName = "RE";
		ds.Tables.add(myDT);

		com.kong.kflowweb.BP.Sys.XML.RegularExpressionDtls dtls = new com.kong.kflowweb.BP.Sys.XML.RegularExpressionDtls();
		dtls.RetrieveAll();
