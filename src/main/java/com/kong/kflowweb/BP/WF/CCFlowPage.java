...
/** 
 PortalPage 的摘要说明。
*/
public class CCFlowPage extends com.kong.kflowweb.BP.Web.PageBase
{
	...
	*/
	public final Entities getHisEns()
	{
		if (this.getEnsName() != null)
		{
			...
			{
				_HisEns = com.kong.kflowweb.BP.En.ClassFactory.GetEns(this.getEnsName());
			}
		}
		return _HisEns;
	}
	...
	*/
	...
	{
		String url = com.kong.kflowweb.BP.Sys.Glo.getRequest().getRequestURL().toString();
...
//	}
	...
	*/
	public final String getParas()
	{
		...
		return com.kong.kflowweb.BP.Sys.Glo.getRequest().getQueryString();
	}
