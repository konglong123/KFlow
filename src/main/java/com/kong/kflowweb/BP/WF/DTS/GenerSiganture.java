...
public class GenerSiganture extends Method
{
	...
	*/
	public GenerSiganture()
	{
		...
		this.Help = "此功能需要用户对 "+ com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + "/Siganture/ 有读写权限，否则会执行失败。";
	}
	/** 
	 设置执行变量
	...
	*/
	...
	public Object Do() throws Exception
	{
		try
		{
			com.kong.kflowweb.BP.Port.Emps emps = new Emps();
			emps.RetrieveAllFromDBSource();
			String path = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + "/Siganture/T.JPG";
			String fontName = "宋体";
			String empOKs = "";
			String empErrs = "";
			for (Emp emp : emps.ToJavaList())
			{
				String pathMe = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + "/Siganture/" + emp.getNo() + ".JPG";
				...
				/*File.Copy(com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + "\\Siganture\\Templete.JPG", path, true);
				...
				File.Copy(pathMe, com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + "\\Siganture\\" + emp.getName() + ".JPG", true);*/
			}
			return "执行成功...";
		}
		catch(RuntimeException ex)
		{
			return "执行失败，请确认对 " + com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + "/Siganture/ 目录有访问权限？异常信息:"+ex.getMessage();
		}
	}
