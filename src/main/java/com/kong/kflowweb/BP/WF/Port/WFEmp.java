...
public class WFEmp extends EntityNoName
{
	...
	*/
	...
	public static void DTSData() throws Exception
	{
		...
		{
			com.kong.kflowweb.BP.Port.Emp emp1 = new com.kong.kflowweb.BP.Port.Emp(dr.getValue("No").toString());
			com.kong.kflowweb.BP.WF.Port.WFEmp empWF = new com.kong.kflowweb.BP.WF.Port.WFEmp();
			empWF.Copy(emp1);
			try
			{
				empWF.setUseSta(1);
