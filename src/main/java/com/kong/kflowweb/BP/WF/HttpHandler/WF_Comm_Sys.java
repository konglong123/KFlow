...
import com.kong.kflowweb.BP.Sys.DBSrcType;
import com.kong.kflowweb.BP.Sys.SFDBSrc;
import com.kong.kflowweb.BP.Sys.SFDBSrcAttr;
import com.kong.kflowweb.BP.Sys.SFDBSrcs;
import com.kong.kflowweb.BP.Sys.SFTable;
import com.kong.kflowweb.BP.Sys.SFTableAttr;
...
import com.kong.kflowweb.BP.Sys.FrmUI.SFTables;
...
public class WF_Comm_Sys extends WebContralBase
{
	...
	*/
	public final String SystemClass_FuncLib()
	{
		...
		String pathDir = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfData() + "/JSLib/";
		...
		pathDir = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + "/JSLib/";
		html += "<fieldset>";
	...
	public final String SystemClass_EnsCheck() throws Exception
	{
		try
		{
			com.kong.kflowweb.BP.En.Entity en = com.kong.kflowweb.BP.En.ClassFactory.GetEn(this.getEnName());
			com.kong.kflowweb.BP.En.Map map = en.getEnMap();
	...
	public final String SystemClass_Init()
	{
		...
		al = com.kong.kflowweb.BP.En.ClassFactory.GetObjects("com.kong.kflowweb.BP.En.Entity");
		for (Object obj : al)
		{
			Entity en = null;
			try
...
//			fileName = multipartFile.getOriginalFilename();
			...
			String savePath = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser()+"JSLibData"+"/"+fileName;
...
//			fileName = multipartFile.getOriginalFilename();
			...
			savePath = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser()+"RichTextFile";
...
//			}
	...
	public final String javaScriptFiles(){
		String savePath = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser()+"JSLibData";
...
//        String fileName = multiFile.getOriginalFilename();
        ...
        //文件存放路径
        String filePath = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfTemp() + "\\" + fileNewName;
        ...
        //从excel里面获得数据表.
        DataTable dt = com.kong.kflowweb.BP.DA.DBLoad.GetTableByExt(filePath);
