...
public class MapFrmFree extends EntityNoName {
	...
	public Map getEnMap() {
		...
		// 数据源.
		map.AddDDLEntities(MapFrmFreeAttr.DBSrc, "local", "数据源", new com.kong.kflowweb.BP.Sys.SFDBSrcs(), true);
		map.AddDDLEntities(MapFrmFreeAttr.FK_FormTree, "01", "表单类别", new SysFormTrees(), true);

		// 表单的运行类型.
		map.AddDDLSysEnum(MapFrmFreeAttr.FrmType, com.kong.kflowweb.BP.Sys.FrmType.FreeFrm.getValue(), "表单类型", true, true,
	...
	public final String DoDFrom() throws Exception {
		String url = Glo.getCCFlowAppPath() + "WF/Admin/FoolFormDesigner/CCForm/Frm.jsp?FK_MapData=" + this.getNo()
				+ "&UserNo=" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "&SID=" + com.kong.kflowweb.BP.Web.WebUser.getSID() + "&AppCenterDBType="
	...
	public final String DoDFromCol4() throws Exception {
		String url = Glo.getCCFlowAppPath() + "WF/Admin/FoolFormDesigner/Designer.htm?FK_MapData=" + this.getNo()
				+ "&UserNo=" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "&SID=" + com.kong.kflowweb.BP.Web.WebUser.getSID()
				+ "&IsFirst=1&AppCenterDBType=" + com.kong.kflowweb.BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo="
