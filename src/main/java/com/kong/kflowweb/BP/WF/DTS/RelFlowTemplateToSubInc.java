	...
	public Object Do() throws Exception
	{
        ...
        for (Flow fl : fls.ToJavaList())
        {
            ...
            for (DataRow dr : dtInc.Rows)
            {
                ...
                com.kong.kflowweb.BP.WF.Template.FlowSort fs = new FlowSort();
                fs.setNo(incNo);
                ...
                //开始把该模版发布到该公司下.
                Flow flInc = new Flow();
                int num= flInc.Retrieve(com.kong.kflowweb.BP.WF.Template.FlowAttr.FK_FlowSort, incNo,
                    com.kong.kflowweb.BP.WF.Template.FlowAttr.FlowMark, fl.getFlowMark());
                if (num == 1)
                    continue; //模版已经存在.
                ...
                try {
                	...
                	com.kong.kflowweb.BP.WF.Flow.DoLoadFlowTemplate(incNo,filePath, ImpFlowTempleteModel.AsNewFlow);
				} catch (Exception e) {
