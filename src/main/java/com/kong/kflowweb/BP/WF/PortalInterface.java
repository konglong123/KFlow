...
public class PortalInterface
{
	...
	*/
	...
	{
		//if (com.kong.kflowweb.BP.Web.WebUser.getNo() != "Guest")
		...
		Emp empStarter = new Emp(com.kong.kflowweb.BP.Web.WebUser.getNo());
		...
		if (parentWorkID != 0)
		{
			com.kong.kflowweb.BP.WF.Dev2Interface.SetParentInfo(flowNo, workID, parentFlowNo, parentWorkID, parentNodeID, parentEmp);
		}
	...
	*/
	...
	{
		//登陆.
		com.kong.kflowweb.BP.Web.GuestUser.SignInOfGener(guestNo, guestName, "CH", true);
	}
	/** 
	 登陆
	...
	*/
	...
	{
		//登陆.
		com.kong.kflowweb.BP.Web.GuestUser.SignInOfGener(guestNo, guestName, deptNo,deptName,"CH", true);
	}
	/** 
	 退出登陆.
	...
	*/
	...
	{
		//登陆.
		com.kong.kflowweb.BP.Web.GuestUser.Exit();
	}
	...
	*/
	public static void SetGuestToDoList(long workID, String guestNo, String guestName)
	{
		...
		ps.Add("GuestName", guestName);
		ps.Add("WorkID", workID);
		int i = com.kong.kflowweb.BP.DA.DBAccess.RunSQL(ps);
		if (i == 0)
		{
		...
		ps.Add("GuestName", guestName);
		ps.Add("WorkID", workID);
		i = com.kong.kflowweb.BP.DA.DBAccess.RunSQL(ps);
		if (i == 0)
		{
	...
	{
		com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineInfo("接口调用成功: SendToWebServices  MyPK" + msgPK +" UserNo:"+sender+ " Tel:" + tel + " msgInfo:" + msgInfo);
	...
	{
	 //   com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineInfo("接口调用成功: SendToWebServices  MyPK" + mypk +" UserNo:"+userNo+ " Tel:" + tel + " msgInfo:" + msgInfo);
	...
	{
	   // com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineInfo("接口调用成功: SendToWeiXin  MyPK" + mypk + " UserNo:" + userNo + " Tel:" + tel + " msgInfo:" + msgInfo);
	...
	{
	    com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineInfo("接口调用成功: SendToEmail  MyPK" + mypk + " email:" + email + " title:" + title + " maildoc:" + maildoc);
		if (com.kong.kflowweb.BP.Sys.SystemConfig.getIsEnableCCIM() && sendToEmpNo != null)
		{
	...
	{
	 //   com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineInfo("接口调用成功: SendToEmail  MyPK" + mypk + " userNo:" + userNo + " msg:" + msg);

		if (com.kong.kflowweb.BP.Sys.SystemConfig.getIsEnableCCIM() && userNo != null)
		{
			com.kong.kflowweb.BP.WF.Glo.SendMessageToCCIM(WebUser.getNo(), userNo, msg, DataType.getCurrentDataTime());
		}
		return true;
	}
