...
import com.kong.kflowweb.BP.En.EntityOIDName;
import com.kong.kflowweb.BP.En.Map;
import com.kong.kflowweb.BP.En.UAC;
import com.kong.kflowweb.BP.GPM.Dept;
import com.kong.kflowweb.BP.GPM.DeptEmp;
import com.kong.kflowweb.BP.GPM.Emp;
		...
		else if (this.getSortVal0().equals("Leader") || this.getSortVal0().equals("SpecEmps"))
		{
				...
				switch (this.getHisFindLeaderType())
				{
					case Submiter: // 当前提交人的直线领导
						empNo = com.kong.kflowweb.BP.Web.WebUser.getNo();
						empDept = com.kong.kflowweb.BP.Web.WebUser.getFK_Dept();
						break;
