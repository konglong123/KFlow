...
public class FlowFormTree extends EntityTree
{
	...
	*/
	...
	//{
	//    if (com.kong.kflowweb.BP.WF.Glo.OSModel == com.kong.kflowweb.BP.Sys.OSModel.OneOne)
	//        return;
	...
	//        // 取得该功能菜单的主键编号.
	//        pMenuNo = DBAccess.GenerOID("com.kong.kflowweb.BP.GPM.Menu").ToString();
	...
	//    string menuNo = DBAccess.GenerOID("com.kong.kflowweb.BP.GPM.Menu").ToString();
	//    // 执行插入.
	//    sql = "INSERT INTO GPM_Menu(No,Name,ParentNo,IsDir,MenuType,FK_App,IsEnable,Flag)";
	...
	//    {
	//        //删除权限管理
	//        if (com.kong.kflowweb.BP.WF.Glo.OSModel == com.kong.kflowweb.BP.Sys.OSModel.OneMore)
