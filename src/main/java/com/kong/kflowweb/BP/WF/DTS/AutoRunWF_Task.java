...
import com.kong.kflowweb.BP.WF.Task;
import com.kong.kflowweb.BP.WF.TaskAttr;
    ...
    public  Object Do() throws Exception
    {
        ...
        for (DataRow dr : dt.Rows)
        {
            ...
            try
            {
                ...
                if (com.kong.kflowweb.BP.Web.WebUser.getNo() != starter)
                {
                    com.kong.kflowweb.BP.Web.WebUser.Exit();
                    com.kong.kflowweb.BP.Port.Emp empadmin = new com.kong.kflowweb.BP.Port.Emp(starter);
