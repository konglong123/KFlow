...
public class Monitor extends Entity
{
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddDDLEntities(MonitorAttr.FK_Dept, null, "发起部门", new com.kong.kflowweb.BP.Port.Depts(), false);
		...
		map.AddSearchAttr(MonitorAttr.FK_Flow);
			...
			//    MonitorAttr.WorkerDept, "=", com.kong.kflowweb.BP.Web.WebUser.getFK_Dept(), 0, true);
		...
		rm.getHisAttrs().AddDDLEntities("ToEmp", null, "移交给:", new com.kong.kflowweb.BP.WF.Data.MyDeptEmps(),true);
