...
public class WF_Admin_FoolFormDesigner_ImpExp extends WebContralBase {
    ...
    public String Imp_Init() throws Exception
    {
        ...
        //#region 数据源
        com.kong.kflowweb.BP.Sys.SFDBSrcs ens = new com.kong.kflowweb.BP.Sys.SFDBSrcs();
        ens.RetrieveAll();
...
//        ds.readXml(getRequest().getParameter("file"));
  ...
  /// 从表单库导入
     ...
     
    {
               ...
               MapData.ImpMapData(this.getFK_MapData(), com.kong.kflowweb.BP.Sys.CCFormAPI.GenerHisDataSet_AllEleInfo(md.getNo()));
    ...
    public String Imp_Src_Step2_Init() throws Exception
    {
        ...
        return com.kong.kflowweb.BP.Tools.FormatToJson.ToJson(dtTables);
    }
    ...
    public String Imp_Src_Step3_Init() throws Exception
    {
        ...
        return com.kong.kflowweb.BP.Tools.FormatToJson.ToJson(ds);
