...
import com.kong.kflowweb.BP.Port.DeptAttr;
import com.kong.kflowweb.BP.Port.EmpAttr;
...
import com.kong.kflowweb.BP.WF.Port.StationAttr;
import com.kong.kflowweb.BP.En.Dot2DotModel;
...
public class NodeSheet extends Entity
{
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.getAttrsOfOneVSM().Add(new com.kong.kflowweb.BP.WF.Template.NodeStations(), new com.kong.kflowweb.BP.Port.Stations(), com.kong.kflowweb.BP.WF.Template.NodeStationAttr.FK_Node, com.kong.kflowweb.BP.WF.Template.NodeStationAttr.FK_Station, DeptAttr.Name, DeptAttr.No,
				"节点绑定岗位", Dot2DotModel.Default,null,null);
		
	   map.getAttrsOfOneVSM().AddGroupListModel(new com.kong.kflowweb.BP.WF.Template.NodeStations(), new com.kong.kflowweb.BP.WF.Port.Stations(),com.kong.kflowweb.BP.WF.Template.NodeStationAttr.FK_Node, com.kong.kflowweb.BP.WF.Template.NodeStationAttr.FK_Station,
			   "节点绑定岗位AddGroupListModel", StationAttr.FK_StationType, DeptAttr.Name,DeptAttr.No);
	   
		
	   map.getAttrsOfOneVSM().Add(new com.kong.kflowweb.BP.WF.Template.NodeDepts(), new com.kong.kflowweb.BP.Port.Depts(), NodeDeptAttr.FK_Node, NodeDeptAttr.FK_Dept, DeptAttr.Name, DeptAttr.No,
       ...
       map.getAttrsOfOneVSM().AddBranchesAndLeaf(new com.kong.kflowweb.BP.WF.Template.NodeEmps(), new com.kong.kflowweb.BP.Port.Emps(),
          ...
          com.kong.kflowweb.BP.WF.Template.NodeEmpAttr.FK_Emp, "节点绑定接受人", EmpAttr.FK_Dept, EmpAttr.Name, EmpAttr.No, "@WebUser.FK_Dept");

       
	   
	  // map.getAttrsOfOneVSM().Add(new com.kong.kflowweb.BP.WF.Template.NodeEmps(),new com.kong.kflowweb.BP.Port.Emps(), NodeEmpAttr.FK_Node, NodeEmpAttr.FK_Emp,DeptAttr.Name, DeptAttr.No,
