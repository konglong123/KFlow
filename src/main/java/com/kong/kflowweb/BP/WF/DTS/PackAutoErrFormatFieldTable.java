...
public class PackAutoErrFormatFieldTable extends Method
{
	...
	*/
	...
	public Object Do() throws Exception
	{
		...
		int idx = 0;
		String msg = "";
		for (com.kong.kflowweb.BP.Sys.MapAttr item : attrs.ToJavaList())
		{
		...
		com.kong.kflowweb.BP.DA.DBAccess.RunSQL("UPDATE Sys_MapAttr SET MyPK=FK_MapData+'_'+KeyOfEn WHERE MyPK!=FK_MapData+'_'+KeyOfEn");
		return "修复信息如下:"+msg;
	}
}