...
import com.kong.kflowweb.BP.WF.Cryptography;
...
public class AdminEmp extends EntityNoName {
	...
	*/
     ...
     * 
     */
    public com.kong.kflowweb.BP.En.Map getEnMap() {
    {
            ...
            map.AddDDLEntities(AdminEmpAttr.FK_Dept, null, "主部门", new com.kong.kflowweb.BP.Port.Depts(), false);
            map.AddDDLEntities(AdminEmpAttr.OrgNo, null, "组织", new com.kong.kflowweb.BP.WF.Port.Incs(), true);
            ...
            map.AddDDLEntities(AdminEmpAttr.RootOfFlow, null, "流程权限节点", new com.kong.kflowweb.BP.WF.Template.FlowSorts(), true);
            map.AddDDLEntities(AdminEmpAttr.RootOfForm, null, "表单权限节点", new com.kong.kflowweb.BP.WF.Template.SysFormTrees(), true);
            map.AddDDLEntities(AdminEmpAttr.RootOfDept, null, "组织结构权限节点", new com.kong.kflowweb.BP.GPM.Depts(), true);
...
*/
	...
	*/
	public String DoAdd(String empNo, String orgNo) throws Exception
    {
        ...
        com.kong.kflowweb.BP.WF.Port.Inc inc = new com.kong.kflowweb.BP.WF.Port.Inc();
        inc.setNo(orgNo);
        if (inc.RetrieveFromDBSources() == 0)
            return "err@orgNo错误, 不存在 Port_Inc 里面。";

        //求根目录流程树.
        com.kong.kflowweb.BP.WF.Template.FlowSort fsRoot = new com.kong.kflowweb.BP.WF.Template.FlowSort();
        fsRoot.Retrieve(com.kong.kflowweb.BP.WF.Template.FlowSortAttr.ParentNo,"0");


        com.kong.kflowweb.BP.WF.Template.FlowSort fs = new com.kong.kflowweb.BP.WF.Template.FlowSort();
        fs.setNo("Inc" + orgNo);
        ...
        //求根目录流程树.
        com.kong.kflowweb.BP.Sys.FrmTree frmRoot = new com.kong.kflowweb.BP.Sys.FrmTree();
        frmRoot.Retrieve(com.kong.kflowweb.BP.WF.Template.FlowSortAttr.ParentNo, "0");

        com.kong.kflowweb.BP.Sys.FrmTree frmTree = new com.kong.kflowweb.BP.Sys.FrmTree();
