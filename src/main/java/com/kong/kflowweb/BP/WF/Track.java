...
*/
public class Track extends com.kong.kflowweb.BP.En.Entity
{
	/** 
	 表单数据
	...
	*/
	public static void CreateOrRepairTrackTable(String fk_flow) throws Exception
	{
		...
		{
			com.kong.kflowweb.BP.DA.Log.DebugWriteError(ex.getMessage()+" @可以容忍的异常....");
		}
	...
	*/
	public final void DoInsert(long mypk) throws Exception
	{
		...
		if (this.FrmDB != null) 
		{
		//	com.kong.kflowweb.BP.DA.DBAccess.SaveBigTextToDB(this.FrmDB, ptable, "MyPK", this.getMyPK(), "FrmDB");
		}
	...
	*/
	...
	protected boolean beforeInsert() throws Exception
	{
		...
		{
			this.setExer(com.kong.kflowweb.BP.Web.GuestUser.getNo() +","+ com.kong.kflowweb.BP.Web.GuestUser.getName());
		}
		else
		{
			if (com.kong.kflowweb.BP.Web.WebUser.getIsAuthorize())
			{
				this.setExer(com.kong.kflowweb.BP.WF.Glo.DealUserInfoShowModel(com.kong.kflowweb.BP.Web.WebUser.getAuth(), com.kong.kflowweb.BP.Web.WebUser.getName()));
			}
			else
			{
				this.setExer(com.kong.kflowweb.BP.WF.Glo.DealUserInfoShowModel(com.kong.kflowweb.BP.Web.WebUser.getNo(), com.kong.kflowweb.BP.Web.WebUser.getName()));
			}
		}

		this.setRDT(com.kong.kflowweb.BP.DA.DataType.getCurrentDataTimess());//getCurrentDataTimess
