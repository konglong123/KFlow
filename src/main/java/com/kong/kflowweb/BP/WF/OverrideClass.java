...
public class OverrideClass {
	...
	public static void FEE(String doType, Node currNode, Entity en, String atPara, SendReturnObjs objs, Node jumpToNode,
		...
		if (doType.equals( EventListOfNode.SendWhen)==true )
		{
          ...
          //当前登录的相关信息
          String no=com.kong.kflowweb.BP.Web.WebUser.getNo();  //当前操作员的编号
          String name=com.kong.kflowweb.BP.Web.WebUser.getName(); //当前操作员的名称.
          String deptNo=com.kong.kflowweb.BP.Web.WebUser.getFK_Dept(); //当前操作员的部门编号
          String deptName=com.kong.kflowweb.BP.Web.WebUser.getFK_DeptName(); //当前操作员的部门名称
