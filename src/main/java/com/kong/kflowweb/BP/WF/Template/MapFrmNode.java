...
public class MapFrmNode extends EntityNoName
{
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddTBString(MapDataAttr.FormEventEntity, null, "事件实体", true, true, 0, 100, 20, true);
			...
			//数据源.
		map.AddDDLEntities(MapFrmNodeAttr.DBSrc, "local", "数据源", new com.kong.kflowweb.BP.Sys.SFDBSrcs(), true);
		...
		map.AddTBInt(MapFrmNodeAttr.FrmH, 1200, "高度", true, false);
			...
			//表单的运行类型.
		map.AddDDLSysEnum(MapFrmNodeAttr.FrmType, com.kong.kflowweb.BP.Sys.FrmType.FreeFrm.getValue(), "表单类型", true, false, MapFrmNodeAttr.FrmType);
	...
	{
		//注册事件表单实体.
		com.kong.kflowweb.BP.Sys.FormEventBase feb = com.kong.kflowweb.BP.Sys.Glo.GetFormEventBaseByEnName(this.getNo());
		if (feb == null)
		{
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() +"WF/Admin/FoolFormDesigner/TabIdx.htm?FK_MapData=" + this.getNo();
	}
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.Sys.CCFormAPI.CopyFrm(this.getNo(), frmID, frmName, fk_frmTree);
	}
	...
	*/
	...
	{
		return "../../Admin/CCFormDesigner/CCFormDesignerSL.htm?FK_MapData="+this.getNo()+"&UserNo="+com.kong.kflowweb.BP.Web.WebUser.getNo()+"&SID="+com.kong.kflowweb.BP.Web.WebUser.getSID();
	}
	/** 
	 启动自由表单设计器(h5)
	...
	*/
	public final String DoDesignerH5() throws Exception
	{
		...
		return "../../Admin/CCFormDesigner/FormDesigner.htm?FK_MapData=" + this.getNo() + "&UserNo=" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "&SID=" + com.kong.kflowweb.BP.Web.WebUser.getSID();
	}
	...
	*/
	...
	{
		String url = "../../Admin/FoolFormDesigner/CCForm/Frm.htm?FK_MapData=" + this.getNo() + "&UserNo=" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "&SID=" + com.kong.kflowweb.BP.Web.WebUser.getSID() + "&AppCenterDBType=" + com.kong.kflowweb.BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo=" + com.kong.kflowweb.BP.Sys.SystemConfig.getCustomerNo();
		try {
	...
	*/
	...
	{
		String url = "../../Admin/FoolFormDesigner/Designer.htm?FK_MapData=" + this.getNo() + "&UserNo=" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "&SID=" + com.kong.kflowweb.BP.Web.WebUser.getSID() + "&AppCenterDBType=" + com.kong.kflowweb.BP.DA.DBAccess.getAppCenterDBType() + "&IsFirst=1&CustomerNo=" + com.kong.kflowweb.BP.Sys.SystemConfig.getCustomerNo();
		try {
			PubClass.WinOpen(ContextHolderUtils.getResponse(),url, 800, 650);
		} catch (IOException e) {
			e.printStackTrace();
	...
	*/
	...
	{
		return "../../Comm/Search.htm?s=34&FK_MapData=" + this.getNo() + "&EnsName=com.kong.kflowweb.BP.Sys.SFDBSrcs";
	}
