...
public class Dev2InterfaceGuest
{
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable("SELECT FK_Flow as No, FlowName AS Name  FROM WF_Node  WHERE IsGuestNode=1 AND NodePosType=0");
	}
	/** 
	 获取Guest的待办
...
//ORIGINAL LINE: public static DataTable DB_GenerRuning(string fk_flow=null, string guestNo=null)
	public static DataTable DB_GenerRuning(String fk_flow, String guestNo) throws Exception
	{
		...
		if (guestNo == null)
		{
			guestNo = com.kong.kflowweb.BP.Web.GuestUser.getNo();
		}
