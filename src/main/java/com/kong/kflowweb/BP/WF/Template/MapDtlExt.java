...
public class MapDtlExt extends EntityNoName {
	...
	*/
	...
	public String OpenAthAttr() {
		String url = "../../Comm/RefFunc/En.htm?EnName=com.kong.kflowweb.BP.Sys.FrmUI.FrmAttachmentExt&PKVal=" + this.getNo()
				+ "_AthMDtl";
		// string url =
		// "../../Admin/FoolFormDesigner/DtlSetting/DtlImp.htm?FK_MapData=" +
		// this.No + "&FromDtl=1&IsFirst=1&UserNo=" + com.kong.kflowweb.BP.Web.WebUser.No +
		// "&SID=" + Web.WebUser.SID + "&AppCenterDBType=" +
		// com.kong.kflowweb.BP.DA.DBAccess.AppCenterDBType + "&CustomerNo=" +
		// com.kong.kflowweb.BP.Sys.SystemConfig.CustomerNo;
		return url;
	}
	...
	public final String DtlImp() throws Exception {
		String url = "../../Admin/FoolFormDesigner/DtlSetting/DtlImp.htm?FK_MapData=" + this.getNo()
				+ "&FromDtl=1&IsFirst=1&UserNo=" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "&SID=" + WebUser.getSID()
				+ "&AppCenterDBType=" + com.kong.kflowweb.BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo="
				+ com.kong.kflowweb.BP.Sys.SystemConfig.getCustomerNo();
		return url;
	}
	...
	public String ColAutoExp() throws Exception {
		String url = "../../Admin/FoolFormDesigner/DtlSetting/ColAutoExp.htm?FK_MapData=" + this.getNo()
				+ "&FromDtl=1&IsFirst=1&UserNo=" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "&SID=" + com.kong.kflowweb.BP.Web.WebUser.getSID()
				+ "&AppCenterDBType=" + com.kong.kflowweb.BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo="
				+ com.kong.kflowweb.BP.Sys.SystemConfig.getCustomerNo();
		return url;
	}
	...
	public final String DFreeFrm() throws Exception {
		...
		String url = "../../Admin/CCFormDesigner/FormDesigner.htm?FK_MapData=" + this.getNo() + "&FromDtl=1&UserNo="
				+ com.kong.kflowweb.BP.Web.WebUser.getNo() + "&SID=" + WebUser.getSID() + "&AppCenterDBType="
				+ com.kong.kflowweb.BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo=" + com.kong.kflowweb.BP.Sys.SystemConfig.getCustomerNo();
		return url;
	}
	...
	public String InitAttrsOfSelf() throws Exception {
		...
		if (this.getIsEnableAthM() == true) {
			...
			if (athDesc.RetrieveFromDBSources() == 0) {
				// 获取原来附件的属性
				com.kong.kflowweb.BP.Sys.FrmAttachment oldAthDesc = new com.kong.kflowweb.BP.Sys.FrmAttachment();
	...
	public final int GetCountByFK(String field, String val) {
		return com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnValInt(
	...
	public final int GetCountByFK(String f1, long val1, String f2, String val2) {
		return com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(OID) from " + this.getPTable() + " WHERE " + f1 + "="
				+ val1 + " AND " + f2 + "='" + val2 + "'");
	}
