...
public class WorkFlowDeleteLog extends EntityOID
{
	...
	public Map getEnMap()
	{
		...
		map.AddDDLEntities(FlowDataAttr.FK_NY, null, "年月", new com.kong.kflowweb.BP.Pub.NYs(),
				false);
