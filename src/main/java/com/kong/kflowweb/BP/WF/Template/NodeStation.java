...
import com.kong.kflowweb.BP.En.EntityMM;
import com.kong.kflowweb.BP.En.Map;
import com.kong.kflowweb.BP.En.UAC;
import com.kong.kflowweb.BP.WF.RememberMe;
import com.kong.kflowweb.BP.WF.RememberMeAttr;
...
public class NodeStation extends EntityMM
{
	...
	*/
	...
	public Map getEnMap()
	{
		...
		{
			map.AddDDLEntitiesPK(NodeStationAttr.FK_Station, null, "工作岗位", new com.kong.kflowweb.BP.Port.Stations(), true);
		}
		else
		{
 // #warning ,这里为了方便用户选择，让分组都统一采用了枚举类型. edit zhoupeng. 2015.04.28. 注意jflow也要修改.
			map.AddDDLEntitiesPK(NodeStationAttr.FK_Station, null, "工作岗位", new com.kong.kflowweb.BP.GPM.Stations(), true);
		}
		this.set_enMap(map);
		return this.get_enMap();
	}
