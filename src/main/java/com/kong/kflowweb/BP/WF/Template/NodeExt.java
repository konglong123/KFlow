...
import com.kong.kflowweb.BP.En.RefMethodType;
...
//        map.AddBoolean(BtnAttr.WorkCheckEnable, false, "是否启用", true, true);
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Comm/EnOnly.htm?EnName=com.kong.kflowweb.BP.WF.Template.FrmSubFlow&PKVal=" + this.getNodeID();
	}
	/** 
	 接受人规则
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/AccepterRole/Default.htm?FK_Node=" + this.getNodeID();
	}
	/** 
	 发送阻塞规则
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/BlockModel.htm?FK_Node=" + this.getNodeID();
	}
	/** 
	 发送后转向规则
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/TurnToDeal.htm?FK_Node=" + this.getNodeID();
	}
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/NodeCCRole.htm?FK_Node=" + this.getNodeID();
	}
	/** 
	 节点组件
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() +"WF/Comm/EnOnly.htm?EnName=com.kong.kflowweb.BP.WF.Template.FrmNodeComponent&PKVal="+this.getNodeID()+"&t=" + DataType.getCurrentDataTime();
	}
	/** 
	 特别用户特殊字段权限.
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/SepcFiledsSepcUsers.htm?FK_Flow=" + this.getFK_Flow() + "&FK_MapData=ND" + this.getNodeID() + "&FK_Node="+this.getNodeID()+"&t=" + DataType.getCurrentDataTime();
	}
	/** 
	 排序字段顺序
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/SortingMapAttrs.htm?FK_Flow=" + this.getFK_Flow() + "&FK_MapData=ND" + this.getNodeID() + "&t=" + DataType.getCurrentDataTime();
	}
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/NodeRunModel.htm?FK_Flow=" + this.getFK_Flow() + "&FK_MapData=ND" + this.getNodeID() + "&t=" + DataType.getCurrentDataTime();
	}
	...
	*/
	...
	{
		com.kong.kflowweb.BP.WF.Node nd = new com.kong.kflowweb.BP.WF.Node(this.getNodeID());
		if (nd.getHisDeliveryWay() != DeliveryWay.ByCCFlowBPM)
		{
			return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/FindWorker/List.htm?FK_Node=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow();
		}
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/NodeAccepterRole.htm?FK_Node=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow();
	}
	/** 
	 找人规则
	 @return 
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/TurnTo.htm?FK_Node=" + this.getNodeID();
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath()+"WF/Comm/En.htm?EnName=com.kong.kflowweb.BP.WF.Template.CC&PK=" + this.getNodeID();
	}
	/** 
	 个性化接受人窗口
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() +"WF/Comm/En.htm?EnName=com.kong.kflowweb.BP.WF.Template.Selector&PK=" + this.getNodeID();
	}
	/** 
	 可触发的子流程
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/Cond/ConditionSubFlow.htm?FK_Node=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow();
	}
	/** 
	 退回节点
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/CanReturnNodes.htm?FK_Node=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow();
	}
	/** 
	 撤销发送的节点
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/CanCancelNodes.htm?FK_Node=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow();
	}
	/** 
	 DXReport
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/DXReport.htm?FK_Node=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow();
	}
	public final String DoPush2Current()
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/Listen.htm?CondType=0&FK_Flow=" + this.getFK_Flow() + "&FK_Node=" + this.getNodeID() + "&FK_Attr=&DirType=&ToNodeID=";
	}
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/FeatureSetUI.htm?CondType=0&FK_Flow=" + this.getFK_Flow() + "&FK_Node=" + this.getNodeID() + "&FK_Attr=&DirType=&ToNodeID=";
	}
	public final String DoShowSheets()
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/ShowSheets.htm?CondType=0&FK_Flow=" + this.getFK_Flow() + "&FK_Node=" + this.getNodeID() + "&FK_Attr=&DirType=&ToNodeID=";
	}
	public final String DoCond()
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/Cond/List.htm?CondType=" + CondType.Flow.getValue() + "&FK_Flow=" + this.getFK_Flow() + "&FK_MainNode=" + this.getNodeID() + "&FK_Node=" + this.getNodeID() + "&FK_Attr=&DirType=&ToNodeID=" + this.getNodeID();
	}
	/** 
	 设计傻瓜表单
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/FoolFormDesigner/Designer.htm?PK=ND" + this.getNodeID();
	}
	/** 
	 设计自由表单
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/FoolFormDesigner/CCForm/Frm.htm?FK_MapData=ND" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow();
	}
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/Sln/BindFrms.htm?ShowType=FlowFrms&FK_Flow=" + this.getFK_Flow() + "&FK_Node=" + this.getNodeID() + "&Lang=CH";
	}
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/PushMessage.htm?FK_Node=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow() + "&tk=" + new java.util.Random().nextDouble();
	}
	/** 
	 事件
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/Action.htm?FK_Node=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow() + "&tk=" + new java.util.Random().nextDouble();
	}
	/** 
	 单据打印
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/AttrNode/Bill.htm?NodeID=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow() +"&FK_Node=" + this.getNodeID();
	}
	/** 
	 设置
	 @return 
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Admin/FAppSet.jsp?NodeID=" + this.getNodeID() + "&FK_Flow=" + this.getFK_Flow();
	}
	...
	protected boolean beforeUpdate() throws Exception
	{
         ...
         if (nd.getIsStartNode() == true)
         {
            ...
            if(this.getFWCAth() == FWCAth.MinAth) {
                ...
                if (workCheckAth.RetrieveFromDBSources() == 0) {
                    ...
                    //多附件.
                    workCheckAth.setUploadType(com.kong.kflowweb.BP.Sys.AttachmentUploadType.Multi);
		...
		//清除所有的缓存.
		com.kong.kflowweb.BP.DA.CashEntity.getDCash().clear();
