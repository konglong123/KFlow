...
public class AppClass {
	...
	public static String SDK_Page_Init(long workid) throws Exception {
		...
		try {
			...
			ds = com.kong.kflowweb.BP.WF.CCFlowAPI.GenerWorkNode(gwf.getFK_Flow(), gwf.getFK_Node(), gwf.getWorkID(), gwf.getFID(),
			...
			if (ds.Tables.contains("com.kong.kflowweb.BP.Port.Depts") == true) {
				ds.Tables.remove("com.kong.kflowweb.BP.Port.Depts");
			}
