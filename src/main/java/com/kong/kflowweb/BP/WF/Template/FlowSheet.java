...
import com.kong.kflowweb.BP.WF.StartLimitRole;
...
public class FlowSheet extends EntityNoName
{
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddTBString(FlowAttr.HelpUrl, null, "帮助文档", true, false, 0, 300, 10, true);
			...
			///#region 启动方式
		map.AddDDLSysEnum(FlowAttr.FlowRunWay, 0, "启动方式", true, true, FlowAttr.FlowRunWay, "@0=手工启动@1=指定人员定时启动@2=定时访问数据集自动启动@3=触发式启动");
	...
	//	map.AddTBStringDoc(FlowAttr.StartGuidePara3, null, "参数3", true, false, true);
		...
		map.AddDDLEntities(FlowAttr.DTSDBSrc, "", "数据库", new com.kong.kflowweb.BP.Sys.SFDBSrcs(), true);
		...
		rm.Icon = com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Img/EntityFunc/Flow/Run.png";
		...
		rm.Icon = com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Img/EntityFunc/Flow/CheckRpt.png";
		...
		rm = new RefMethod();
		rm.Title = "设计报表"; // "报表运行";
		rm.Icon = com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Img/Btn/Rpt.gif";
		rm.ClassMethodName = this.toString() + ".DoOpenRpt()";
		rm.refMethodType = RefMethodType.LinkeWinOpen;
		map.AddRefMethod(rm);

		rm = new RefMethod();
		rm.Icon = com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Img/Btn/Delete.gif";
		...
		rm = new RefMethod();
		rm.Icon = com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Img/Btn/DTS.gif";
		...
		rm = new RefMethod();
		rm.Title = "回滚流程";
		rm.Icon = com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Img/Btn/Back.png";
		...
		rm.Icon = com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Img/Event.png";
		rm.refMethodType = RefMethodType.RightFrameOpen;
		map.AddRefMethod(rm);
	...
	*/
	...
	{
		return Glo.getCCFlowAppPath() + "WF/Admin/AttrFlow/DTSBTable.jsp?s=d34&ShowType=FlowFrms&FK_Node=" + Integer.parseInt(this.getNo()) + "01&FK_Flow=" + this.getNo() + "&ExtType=StartFlow&RefNo=" + DataType.getCurrentDataTime();
	}
	/** 
	 批量修改节点属性.
	...
	*/
	...
	{
		return Glo.getCCFlowAppPath() + "WF/Admin/FeatureSetUI.jsp?s=d34&ShowType=FlowFrms&FK_Node=" + Integer.parseInt(this.getNo()) + "01&FK_Flow=" + this.getNo() + "&ExtType=StartFlow&RefNo=" + DataType.getCurrentDataTime();
	}
	public final String DoBindFlowSheet()
	{
		try {
			...
			Log.DebugWriteError("FlowSheet DoBindFlowSheet()" + e);
		}
		return null;
	}
	/** 
	...
	*/
	public final String DoBatchStartFields()
	{
		try {
			...
			Log.DebugWriteError("FlowSheet DoBatchStartFields()" + e);
		}
		return null;
	}
	...
	*/
	public final String DoFlowFormTree()
	{
		try {
			...
			Log.DebugWriteError("FlowSheet DoFlowFormTree()" + e);
		}
		return null;
	}
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Rpt/OneFlow.jsp?FK_Flow=" + this.getNo() + "&DoType=Edit&FK_MapData=ND" + Integer.parseInt(this.getNo()) + "Rpt";
	}
	/** 
	 更新之后的事情，也要更新缓存。
