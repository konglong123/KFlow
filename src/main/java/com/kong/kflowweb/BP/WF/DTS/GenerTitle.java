...
public class GenerTitle extends Method
{
	...
	*/
	...
	{
		com.kong.kflowweb.BP.WF.Template.FlowExts ens = new com.kong.kflowweb.BP.WF.Template.FlowExts();
		for (com.kong.kflowweb.BP.WF.Template.FlowExt en : ens.ToJavaList())
		{
			en.DoGenerTitle();
		}
		return "执行成功...";
