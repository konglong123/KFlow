...
public class GenerWorkFlows extends Entities
{
	...
	*/
	...
	{
		java.util.ArrayList<com.kong.kflowweb.BP.WF.GenerWorkFlow> list = new java.util.ArrayList<com.kong.kflowweb.BP.WF.GenerWorkFlow>();
		for (int i = 0; i < this.size(); i++)
		{
			list.add((com.kong.kflowweb.BP.WF.GenerWorkFlow)this.get(i));
		}
		return list;
	}
