...
public class LoadNDxxRpt2GernerWorkFlow extends Method
{
	...
	*/
	...
	{
		com.kong.kflowweb.BP.WF.Flows ens = new Flows();
		for (com.kong.kflowweb.BP.WF.Flow en : ens.ToJavaList())
		{
			...
			for (DataRow dr : dt.Rows)
			{
				...
				gwf.setWFState(com.kong.kflowweb.BP.WF.WFState.forValue(Integer.parseInt(dr.get(NDXRptBaseAttr.WFState).toString())));
				gwf.setWFSta(com.kong.kflowweb.BP.WF.WFSta.Complete);
