	...
	*/
	public final int GetMyPK32()
	{
		try
		{
			...
			DataTable dt = com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(String.format(sql, this.WorkID, this.NodeID, this.FlowNo));
	...
	*/
	...
	public final Tracks getHisWorkChecks() throws Exception
	{
		if (_HisWorkChecks == null)
		{
			...
			com.kong.kflowweb.BP.En.QueryObject qo = new QueryObject(_HisWorkChecks);
			...
			DataTable dt = com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(sql, qo.getMyParas());

			//dt.DefaultView.Sort = "RDT desc";			
			com.kong.kflowweb.BP.En.Attrs attrs = _HisWorkChecks.getGetNewEntity().getEnMap().getAttrs();
			...
			{
				Track en = new Track();
				for (com.kong.kflowweb.BP.En.Attr attr : attrs)
				{					
					 if (isOracle==true)
