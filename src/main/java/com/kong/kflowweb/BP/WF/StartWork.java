...
public abstract class StartWork extends Work{
	...
	public SQLCash getSQLCash() throws Exception
	{
		if (_SQLCash == null)
		{
			_SQLCash = com.kong.kflowweb.BP.DA.Cash.GetSQL("ND" + (new Integer(this.getNodeID())).toString());
			if (_SQLCash == null)
			{
				_SQLCash = new SQLCash(this);
				com.kong.kflowweb.BP.DA.Cash.SetSQL("ND" + (new Integer(this.getNodeID())).toString(), _SQLCash);
			}
		}
		return _SQLCash;
	}
	...
	*/
	...
	{
		this.setEmps(com.kong.kflowweb.BP.Web.WebUser.getNo());
