...
public class Bill extends EntityMyPK
{
	...
	public Map getEnMap()
	{
		...
		map.AddDDLEntities(BillAttr.FK_Dept, null, "隶属部门", new com.kong.kflowweb.BP.Port.Depts(),
				false);
		
		map.AddDDLEntities(BillAttr.FK_NY, null, "隶属年月", new com.kong.kflowweb.BP.Pub.NYs(),
				false);
