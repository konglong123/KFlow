...
/** 
 报表
*/
public class FlowData extends com.kong.kflowweb.BP.En.EntityOID
{
	/** 
	 流程发起人
	*/
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddDDLEntities(FlowDataAttr.FK_Dept, null, "部门", new com.kong.kflowweb.BP.GPM.Depts(), false);
		...
		map.AddDDLEntities(FlowDataAttr.FK_NY, null, "年月", new com.kong.kflowweb.BP.Pub.NYs(), false);
