...
*/
	...
	*/
	...
	{
		if (value == com.kong.kflowweb.BP.WF.WFState.Complete)
		{
			SetValByKey(GenerWorkFlowAttr.WFSta, getWFSta().Complete.getValue());
		}
		else if (value == com.kong.kflowweb.BP.WF.WFState.Delete)
		{
	...
	*/
	...
	{
		return this.GetParaBoolen("F_"+com.kong.kflowweb.BP.Web.WebUser.getNo(),false);
	}
	public final void setParas_Focus(boolean value) throws Exception
	{
		this.SetPara("F_" + com.kong.kflowweb.BP.Web.WebUser.getNo(), value);
	}
	/** 
	 最后一个执行发送动作的ID.
...
*/
	...
	*/
	...
	protected boolean beforeInsert() throws Exception
	{
		...
		{
			this.setStarterName(com.kong.kflowweb.BP.Web.GuestUser.getName());
			this.setGuestName(this.getStarterName());
			this.setGuestNo(com.kong.kflowweb.BP.Web.GuestUser.getNo());
		}
	...
	*/
	...
	{
		return this.GetParaBoolen("C_"+com.kong.kflowweb.BP.Web.WebUser.getNo(),false);
	}
	public final void setParas_Confirm(boolean value) throws Exception
	{
		this.SetPara("C_" + com.kong.kflowweb.BP.Web.WebUser.getNo(), value);
	}
