...
public class FlowExts extends EntitiesNoName
{
	...
	*/
	public final int Retrieve(String FlowSort) throws Exception
	{
		...
		qo.AddWhere(com.kong.kflowweb.BP.WF.Template.FlowAttr.FK_FlowSort, FlowSort);
		qo.addOrderBy(com.kong.kflowweb.BP.WF.Template.FlowAttr.No);
		return qo.DoQuery();
	}
	...
	*/
	...
	{
		this.Retrieve(com.kong.kflowweb.BP.WF.Template.FlowAttr.FK_FlowSort, fk_sort);
	}
