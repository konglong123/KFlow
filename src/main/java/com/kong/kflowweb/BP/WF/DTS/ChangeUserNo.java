...
public class ChangeUserNo extends Method
{
	...
	*/
	public ChangeUserNo()
	{
		...
		this.Help = "请慎重执行，执行前请先备份数据库，系统会把生成的SQL放在日志里，打开日志文件(" + com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + "/Log)，然后找到这些sql.";
	}
	/** 
	 设置执行变量
	...
	*/
	...
	public Object Do() throws Exception
	{
		...
		sqls += "\t\n UPDATE " + com.kong.kflowweb.BP.WF.Glo.getEmpStation() + " Set FK_Emp='" + newNo + "' WHERE FK_Emp='" + oldNo + "'";
