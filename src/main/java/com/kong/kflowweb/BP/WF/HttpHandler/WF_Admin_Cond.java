...
public class WF_Admin_Cond extends WebContralBase {
	...
	public final String CondByFrm_Init() throws Exception {
		...
		return com.kong.kflowweb.BP.Tools.Json.ToJson(ds); // cond.ToJson();
	}
	...
	public final String CondByStation_Init() throws Exception {
		...
		// 岗位类型.
		com.kong.kflowweb.BP.GPM.StationTypes tps = new com.kong.kflowweb.BP.GPM.StationTypes();
		tps.RetrieveAll();
	...
	public final String CondByFrm_Save() throws Exception {
		...
		case Flow:
		case Node:
			cond.setMyPK(com.kong.kflowweb.BP.DA.DBAccess.GenerOID() + "");
