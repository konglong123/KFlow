...
public class AppACE extends WebContralBase{
	...
	public final String DB_GenerReturnWorks() throws Exception
	{
		...
		rws.Retrieve(com.kong.kflowweb.BP.WF.ReturnWorkAttr.ReturnToNode, this.getFK_Node(), com.kong.kflowweb.BP.WF.ReturnWorkAttr.WorkID, this.getWorkID(), com.kong.kflowweb.BP.WF.ReturnWorkAttr.RDT);
	...
	public final String GetUserInfo() throws Exception
	{
		...
		String userIcon = userPath + com.kong.kflowweb.BP.Web.WebUser.getNo() + "Biger.png";
		File file = new File(userIcon);
		if (file.exists())
		{
			append.append("UserIcon:'" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "Biger.png'");
		}
		else
		{
			append.append("UserIcon:'DefaultBiger.png'");
		}
		append.append(",UserName:'" + com.kong.kflowweb.BP.Web.WebUser.getName() + "'");
		append.append(",UserDeptName:'" + com.kong.kflowweb.BP.Web.WebUser.getFK_DeptName() + "'");
		append.append("}");
		return append.toString();
	}
    ...
    public String Home_Menu()
    {
		...
		com.kong.kflowweb.BP.WF.XML.ClassicMenus menus = new com.kong.kflowweb.BP.WF.XML.ClassicMenus();
		menus.RetrieveAll();
    ...
    */
    ...
    public String Draft_Delete()
    {
        try
        {
            com.kong.kflowweb.BP.WF.Dev2Interface.Node_DeleteDraft(this.getFK_Flow(), this.getWorkID());
            return "删除成功";
        }
        catch (Exception e)
        {
