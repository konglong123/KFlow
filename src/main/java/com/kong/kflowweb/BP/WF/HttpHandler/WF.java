...
import com.kong.kflowweb.BP.WF.Dev2Interface;
import com.kong.kflowweb.BP.WF.DoWhatList;
...
import com.kong.kflowweb.BP.WF.GenerWorkerList;
import com.kong.kflowweb.BP.WF.GenerWorkerListAttr;
import com.kong.kflowweb.BP.WF.Node;
import com.kong.kflowweb.BP.WF.NodeFormType;
import com.kong.kflowweb.BP.WF.RunModel;
import com.kong.kflowweb.BP.WF.SMS;
import com.kong.kflowweb.BP.WF.SMSMsgType;
import com.kong.kflowweb.BP.WF.Track;
import com.kong.kflowweb.BP.WF.WFSta;
import com.kong.kflowweb.BP.WF.WFState;
import com.kong.kflowweb.BP.WF.Work;
import com.kong.kflowweb.BP.WF.WorkFlow;
import com.kong.kflowweb.BP.WF.Works;
import com.kong.kflowweb.BP.WF.Data.Bill;
...
import com.kong.kflowweb.BP.WF.Template.BtnLab;
import com.kong.kflowweb.BP.WF.Template.CCList;
import com.kong.kflowweb.BP.WF.Template.CCSta;
import com.kong.kflowweb.BP.WF.Template.FTCAttr;
import com.kong.kflowweb.BP.WF.Template.FlowSortAttr;
...
public class WF extends WebContralBase {
	...
	public String HasSealPic() throws Exception
    {
        ...
        if (file.exists() == false)
        {
            ...
            //如果不存在，就返回名称
            com.kong.kflowweb.BP.Port.Emp emp = new com.kong.kflowweb.BP.Port.Emp(no);
            return emp.getName();
        }
	...
	public String DoDefaultMethod() {
		...
		try {
			...
			{
				com.kong.kflowweb.BP.WF.Dev2Interface.Port_SigOut();
			} else if ("AuthExit".equals(getDoType())) {
				msg = this.AuthExitAndLogin(this.getNo(), com.kong.kflowweb.BP.Web.WebUser.getAuth());
			} else {
        ...
        try
        {
            switch (at)
            {
                ...
                case "PutOne": //把任务放入任务池.
                    com.kong.kflowweb.BP.WF.Dev2Interface.Node_TaskPoolPutOne(this.getWorkID());
                    return "info@Close";
                case "DoAppTask": // 申请任务.
                    com.kong.kflowweb.BP.WF.Dev2Interface.Node_TaskPoolTakebackOne(this.getWorkID());
                    return "info@Close";
                case "DoOpenCC":
                    ...
                    if (Sta == "0")
                    {
                        com.kong.kflowweb.BP.WF.Template.CCList cc1 = new com.kong.kflowweb.BP.WF.Template.CCList();
                ...
                case "DelSubFlow": //删除进程。
                    try
                    {
                        com.kong.kflowweb.BP.WF.Dev2Interface.Flow_DeleteSubThread(this.getFK_Flow(), this.getWorkID(), "手工删除");
                        return "info@Close";
                    }
                    catch (Exception ex)
                    {
                ...
                case "DelDtl":
                    ...
                    try
                    {
                        fes.DoEventNode(com.kong.kflowweb.BP.WF.XML.EventListDtlList.DtlItemDelBefore, dtl);
                    }
                    catch (Exception ex)
                    {
                        return "err@" + ex.getMessage();
                    ...
                    try
                    {
                        fes.DoEventNode(com.kong.kflowweb.BP.WF.XML.EventListDtlList.DtlItemDelAfter, dtl);
                    }
                    catch (Exception ex)
                    {
                        return "err@" + ex.getMessage();
                    ...
                    return "info@Close";
                case "EmpDoUp":
                    com.kong.kflowweb.BP.WF.Port.WFEmp ep = new com.kong.kflowweb.BP.WF.Port.WFEmp(this.GetRequestVal("RefNo"));
                    ep.DoUp();

                    com.kong.kflowweb.BP.WF.Port.WFEmps emps111 = new com.kong.kflowweb.BP.WF.Port.WFEmps();
                    //  emps111.RemoveCash();
                    emps111.RetrieveAll();
                    return "info@Close";
                case "EmpDoDown":
                    com.kong.kflowweb.BP.WF.Port.WFEmp ep1 = new com.kong.kflowweb.BP.WF.Port.WFEmp(this.GetRequestVal("RefNo"));
                    ep1.DoDown();

                    com.kong.kflowweb.BP.WF.Port.WFEmps emps11441 = new com.kong.kflowweb.BP.WF.Port.WFEmps();
                ...
                case "Track": //通过一个串来打开一个工作.
                    ...
                    com.kong.kflowweb.BP.Web.WebUser.SignInOfGener(new com.kong.kflowweb.BP.Port.Emp(fk_emp));
                ...
                case "OF": //通过一个串来打开一个工作.
                    ...
                    com.kong.kflowweb.BP.Port.Emp empOF = new com.kong.kflowweb.BP.Port.Emp(wl.getFK_Emp());
                    com.kong.kflowweb.BP.Web.WebUser.SignInOfGener(empOF);
                    String u = "MyFlow.htm?FK_Flow=" + wl.getFK_Flow() + "&WorkID=" + wl.getWorkID() + "&FK_Node=" + wl.getFK_Node() + "&FID=" + wl.getFID();
                    return "url@" + u;
                case "ExitAuth":
                    com.kong.kflowweb.BP.Port.Emp emp = new com.kong.kflowweb.BP.Port.Emp(this.getFK_Emp());
                    //首先退出，再进行登录
                    com.kong.kflowweb.BP.Web.WebUser.Exit();
                    com.kong.kflowweb.BP.Web.WebUser.SignInOfGener(emp, WebUser.getSysLang());
                    return "info@Close";
                case "LogAs":
                    com.kong.kflowweb.BP.WF.Port.WFEmp wfemp = new com.kong.kflowweb.BP.WF.Port.WFEmp(this.getFK_Emp());
                    if (wfemp.getAuthorIsOK() == false)
                    {
                        return "err@授权失败";
                    }
                    com.kong.kflowweb.BP.Port.Emp emp1 = new com.kong.kflowweb.BP.Port.Emp(this.getFK_Emp());
                    com.kong.kflowweb.BP.Web.WebUser.SignInOfGener(emp1, "CH", false, false, wfemp.getAuthor(), WebUser.getName());
                    return "info@Close";
                case "TakeBack": // 取消授权。
                    com.kong.kflowweb.BP.WF.Port.WFEmp myau = new com.kong.kflowweb.BP.WF.Port.WFEmp(WebUser.getNo());
                    ...
                    return "info@Close";
                case "AutoTo": // 执行授权。
                    com.kong.kflowweb.BP.WF.Port.WFEmp au = new com.kong.kflowweb.BP.WF.Port.WFEmp();
                    au.setNo(WebUser.getNo());
                    au.RetrieveFromDBSources();
                    au.setAuthorDate(com.kong.kflowweb.BP.DA.DataType.getCurrentDate());
                    au.setAuthor(this.getFK_Emp());
                    au.setAuthorWay(1);
                    au.Save();
                    com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineInfo("执行授权:" + WebUser.getNo() + "执行了对(" + au.getAuthor() + ")的授权。");
                    return "info@Close";
                case "UnSend": //执行撤消发送。
                ...
                case "DeleteFlow":
                    ...
                    return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/MyFlowInfo.htm?Msg=流程删除成功";
	...
	public String HungUpList_Init() throws Exception {
		DataTable dt = null;
		dt = com.kong.kflowweb.BP.WF.Dev2Interface.DB_GenerHungUpList();
		return com.kong.kflowweb.BP.Tools.Json.ToJson(dt);
	}
	...
	public String Draft_Init() throws Exception {
		DataTable dt = null;
		dt = com.kong.kflowweb.BP.WF.Dev2Interface.DB_GenerDraftDataTable();

		// 转化大写.
		return com.kong.kflowweb.BP.Tools.Json.DataTableToJson(dt, false);
	}
	...
	public String Todolist_Author() {
		...
		// 转化大写的toJson.
		return com.kong.kflowweb.BP.Tools.Json.DataTableToJson(dt, true);
	}
	...
	public String Todolist_Init() {
		...
		try {
			dt = com.kong.kflowweb.BP.WF.Dev2Interface.DB_GenerEmpWorksOfDataTable(com.kong.kflowweb.BP.Web.WebUser.getNo(), this.getFK_Node());
		} catch (Exception e) {
	...
	public String LoginInit() throws Exception {
		...
		if (com.kong.kflowweb.BP.Web.WebUser.getNo() == null)
			ht.put("UserNo", "");
		else
			ht.put("UserNo", com.kong.kflowweb.BP.Web.WebUser.getNo());

		if (com.kong.kflowweb.BP.Web.WebUser.getIsAuthorize())
			ht.put("Auth", com.kong.kflowweb.BP.Web.WebUser.getAuth());
		else
			ht.put("Auth", "");
	...
	public String LoginSubmit() throws Exception {
		...
		// 让其登录.
		String sid = com.kong.kflowweb.BP.WF.Dev2Interface.Port_Login(emp.getNo());
		return sid;
	}
	...
	public String AuthExitAndLogin(String UserNo, String Author) {
		...
		try {
			...
			com.kong.kflowweb.BP.Web.WebUser.Exit();
			// 再进行登录
			com.kong.kflowweb.BP.Port.Emp emp1 = new com.kong.kflowweb.BP.Port.Emp(Author);
			com.kong.kflowweb.BP.Web.WebUser.SignInOfGener(emp1, "CH", false, false, null, null);
		} catch (Exception ex) {
	...
	public String AuthorList_Init() throws Exception {
         ...
         ps.Add("AUTHOR", com.kong.kflowweb.BP.Web.WebUser.getNo());
         DataTable dt = com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(ps);
	...
	public String IsHaveAuthor() throws Exception {
		DataTable dt = com.kong.kflowweb.BP.DA.DBAccess
				.RunSQLReturnTable("SELECT * FROM WF_EMP WHERE AUTHOR='" + com.kong.kflowweb.BP.Web.WebUser.getNo() + "'");
		WFEmp em = new WFEmp();
		em.Retrieve(WFEmpAttr.Author, com.kong.kflowweb.BP.Web.WebUser.getNo());

		if (dt.Rows.size() > 0 && com.kong.kflowweb.BP.Web.WebUser.getIsAuthorize() == false)
			return "suess@有授权";
		else
			return "err@没有授权";
	}
	...
	public final String Start_Init() throws Exception {
        ...
        com.kong.kflowweb.BP.WF.Port.WFEmp em = new WFEmp();
        em.setNo(com.kong.kflowweb.BP.Web.WebUser.getNo());
        if (em.RetrieveFromDBSources() == 0)
        {
            em.setFK_Dept(com.kong.kflowweb.BP.Web.WebUser.getFK_Dept());
            em.setName(WebUser.getName());
            em.Insert();
        }
        String json="";
        json = com.kong.kflowweb.BP.DA.DBAccess.GetBigTextFromDB("WF_Emp", "No", WebUser.getNo(), "StartFlows");
        ...
        json = com.kong.kflowweb.BP.Tools.Json.ToJson(ds);
       //把json存入数据表，避免下一次再取.
        if (json.length() > 40)
        {
            com.kong.kflowweb.BP.DA.DBAccess.SaveBigTextToDB(json, "WF_Emp", "No", WebUser.getNo(), "StartFlows");
	...
	public final String Start_Init2016() throws Exception {
		...
		DataTable dtStart = Dev2Interface.DB_GenerCanStartFlowsOfDataTable(com.kong.kflowweb.BP.Web.WebUser.getNo());
		dtStart.TableName = "Start";

		// String str=com.kong.kflowweb.BP.Tools.Json.ToJson(dtStart);

		ds.Tables.add(dtStart);

		// 返回组合
		String st1 = com.kong.kflowweb.BP.Tools.Json.ToJson(ds);
	...
	public final String TaskPoolSharing_Init() throws Exception {
		DataTable dt = com.kong.kflowweb.BP.WF.Dev2Interface.DB_TaskPool();
	...
	public String TaskPoolSharing_Apply() {
		boolean b = false;
		try {
			b = com.kong.kflowweb.BP.WF.Dev2Interface.Node_TaskPoolTakebackOne(this.getWorkID());
		} catch (Exception e) {
	...
	public final String TaskPoolApply_Init() throws Exception {
		DataTable dt = com.kong.kflowweb.BP.WF.Dev2Interface.DB_TaskPoolOfMyApply();
	...
	public final String Runing_UnSend() throws Exception {
		try {
			...
			return com.kong.kflowweb.BP.WF.Dev2Interface.Flow_DoUnSend(this.getFK_Flow(), this.getWorkID(),unSendToNode,this.getFID());
	...
	public final String Runing_Press() throws Exception {
		try {
			return com.kong.kflowweb.BP.WF.Dev2Interface.Flow_DoPress(this.getWorkID(), this.GetRequestVal("Msg"), false);
		} catch (RuntimeException ex) {
			return "err@" + ex.getMessage();
		}
	}
	...
	public final String Draft_Delete() throws Exception {
		return com.kong.kflowweb.BP.WF.Dev2Interface.Flow_DoDeleteDraft(this.getFK_Flow(), this.getWorkID(), false);
	}
	...
	public final String Focus_Init() throws Exception {
		...
		for (DataRow dr : dt.Rows) {
			...
			dr.setValue("AtPara",
					(wfsta == com.kong.kflowweb.BP.WF.WFSta.Complete.getValue() ? DotNetToJavaStringHelper
	...
	public final String FrmView_Init() throws Exception {
		...
		// 获得表单模版.
		DataSet myds = com.kong.kflowweb.BP.Sys.CCFormAPI.GenerHisDataSet(md.getNo(), null);

		///把主从表数据放入里面.
		// .工作数据放里面去, 放进去前执行一次装载前填充事件.
		com.kong.kflowweb.BP.WF.Work wk = nd.getHisWork();
...
//		wk.ResetDefaultVal();
		...
		//增加附件信息.
		com.kong.kflowweb.BP.Sys.FrmAttachments athDescs = new FrmAttachments();
		...
		for (DataRow dr : dtMapAttr.Rows) {
			...
			if (me != null) {
				...
				fullSQL = com.kong.kflowweb.BP.WF.Glo.DealExp(fullSQL, wk, null);
			...
			DataTable mydt = com.kong.kflowweb.BP.Sys.PubClass.GetDataTableByUIBineKey(uiBindKey);
	...
	public final String Port_Init() throws Exception {
		...
		//登录校验.
		if (com.kong.kflowweb.BP.Web.WebUser.getNo().equals(this.getUserNo()) == false) {
			...
			if (com.kong.kflowweb.BP.WF.Dev2Interface.Port_CheckUserLogin(this.getUserNo(), this.getSID()) == false) {
			...
			if (com.kong.kflowweb.BP.Web.WebUser.getNo().equals(this.getUserNo()) == false) {
				com.kong.kflowweb.BP.WF.Dev2Interface.Port_SigOut();
				try {
					com.kong.kflowweb.BP.WF.Dev2Interface.Port_Login(this.getUserNo(), this.getSID());
				} catch (RuntimeException ex) {
		...
		if (this.getDoWhat().equals(DoWhatList.DealMsg) == true) {
			...
			// 判断当前的登录人员.
			if (com.kong.kflowweb.BP.Web.WebUser.getNo() != sms.getSendToEmpNo()) {
				com.kong.kflowweb.BP.WF.Dev2Interface.Port_Login(sms.getSendToEmpNo());
			}

			com.kong.kflowweb.BP.DA.AtPara ap = new AtPara(sms.getAtPara());
			if (sms.getMsgType() == SMSMsgType.SendSuccess) { // 发送成功的提示.

				if (com.kong.kflowweb.BP.WF.Dev2Interface.Flow_IsCanDoCurrentWork( ap.GetValInt64ByKey("WorkID"), com.kong.kflowweb.BP.Web.WebUser.getNo()) == true) {
    ...
    public String BatchList_Init() throws Exception
    {
        ...
        //获取节点信息
        com.kong.kflowweb.BP.WF.Node nd = new com.kong.kflowweb.BP.WF.Node(this.getFK_Node());
        ...
        for(DataRow dr : dt.Rows)
        {
            ...
            for(String str : strs)
            {
                ...
                for(MapAttr attr : attrs.ToJavaList())
                {
                    ...
                    if (attr.getUIContralType() == com.kong.kflowweb.BP.En.UIContralType.TB && attr.getUIIsEnable() == true)
                    {
                        String val = this.GetValFromFrmByKey("TB_" + workid + "_" + attr.getKeyOfEn(), null);
                        ht.put(str, val);
                        continue;
                    ...
                    if (attr.getUIContralType() == com.kong.kflowweb.BP.En.UIContralType.DDL && attr.getUIIsEnable() == true)
                    {
                    ...
                    if (attr.getUIContralType() == com.kong.kflowweb.BP.En.UIContralType.CheckBok && attr.getUIIsEnable() == true)
                    {
            ...
            if (DataType.IsNullOrEmpty(checkNote) == false)
                com.kong.kflowweb.BP.WF.Dev2Interface.WriteTrackWorkCheck(nd.getFK_Flow(), nd.getNodeID(), workid, Long.parseLong(dr.getValue("FID").toString()), checkNote,null);
            
            msg += "@对工作(" + dr.getValue("Title") + ")处理情况如下";
            com.kong.kflowweb.BP.WF.SendReturnObjs objs = com.kong.kflowweb.BP.WF.Dev2Interface.Node_SendWork(nd.getFK_Flow(), workid, ht);
    ...
    public String Batch_Return() throws Exception
    {
        ...
        for (DataRow dr : dt.Rows)
        {
            ...
            com.kong.kflowweb.BP.WF.SendReturnObjs objs = null;// com.kong.kflowweb.BP.WF.Dev2Interface.Node_ReturnWork(nd.FK_Flow, workid,fid,this.FK_Node,"批量退回");
            msg += objs.ToMsgOfHtml();
            msg += "<hr>";
    ...
    public String Batch_Delete() throws Exception
    {
        ...
        for (DataRow dr : dt.Rows)
        {
            ...
            msg += "@对工作(" + dr.getValue("Title")+ ")处理情况如下。<br>";
            String mes = com.kong.kflowweb.BP.WF.Dev2Interface.Flow_DoDeleteFlowByFlag(nd.getFK_Flow(), workid, "批量退回", true);
            msg += mes;
            msg += "<hr>";
