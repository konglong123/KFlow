...
public class CHExt extends EntityMyPK
{
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddDDLEntities(CHAttr.FK_Dept, null, "隶属部门", new com.kong.kflowweb.BP.Port.Depts(), false);
		map.AddDDLEntities(CHAttr.FK_Emp, null, "当事人", new com.kong.kflowweb.BP.Port.Emps(), false);
		map.AddDDLEntities(CHAttr.FK_NY, null, "月份", new com.kong.kflowweb.BP.Pub.NYs(), false);
