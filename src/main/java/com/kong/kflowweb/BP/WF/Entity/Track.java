...
public class Track extends com.kong.kflowweb.BP.En.Entity
{
	...
	protected boolean beforeInsert() throws Exception
	{
		...
		} else
		{
			...
			{
				this.setExer(com.kong.kflowweb.BP.WF.Glo.DealUserInfoShowModel(
						WebUser.getAuthorizerEmpID(), WebUser.getAuth()));
			} else
			{
				this.setExer(com.kong.kflowweb.BP.WF.Glo.DealUserInfoShowModel(WebUser.getNo(),
						WebUser.getName()));
			}
		}
		
		this.setRDT(com.kong.kflowweb.BP.DA.DataType.getCurrentDataTimess());
