...
import com.kong.kflowweb.BP.WF.Template.NodeEmpAttr;
import com.kong.kflowweb.BP.WF.Template.NodeEmps;
import com.kong.kflowweb.BP.WF.Template.NodeStation;
import com.kong.kflowweb.BP.WF.Template.NodeStations;
import com.kong.kflowweb.BP.Web.WebUser;

/** 
 取回任务
*/
public class GetTask extends com.kong.kflowweb.BP.En.Entity
{
	/** 
	 我可以处理当前的工作吗？
	 @return 
