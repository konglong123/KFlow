...
import com.kong.kflowweb.BP.Sys.FrmTreeAttr;
...
import com.kong.kflowweb.BP.WF.Flows;
import com.kong.kflowweb.BP.WF.Port.AdminEmp;
import com.kong.kflowweb.BP.WF.Template.DataStoreModel;
import com.kong.kflowweb.BP.WF.Template.Direction;
import com.kong.kflowweb.BP.WF.Template.DirectionAttr;
...
import com.kong.kflowweb.BP.WF.Template.LabNote;
import com.kong.kflowweb.BP.WF.Template.LabNoteAttr;
import com.kong.kflowweb.BP.WF.Template.NodeAttr;
import com.kong.kflowweb.BP.WF.Template.SysFormTree;
import com.kong.kflowweb.BP.WF.Template.WorkflowDefintionManager;
import com.kong.kflowweb.BP.WF.XML.AdminMenu;
import com.kong.kflowweb.BP.WF.XML.AdminMenuGroup;
import com.kong.kflowweb.BP.WF.XML.AdminMenuGroups;
import com.kong.kflowweb.BP.WF.XML.AdminMenus;
...
public class WF_Admin_CCBPMDesigner extends WebContralBase
{
	...
	*/
    ...
    {
        DataSet ds = com.kong.kflowweb.BP.Sys.CCFormAPI.GenerHisDataSet_AllEleInfo(this.getFK_MapData());
        String file = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfTemp() + this.getFK_MapData() + ".xml";
        //表单导出方式修改
	...
	*/
	public final String GetEmpsByStationTable() throws Exception
	{
		...
		if (com.kong.kflowweb.BP.WF.Glo.getOSModel() == OSModel.OneOne)
		{
			com.kong.kflowweb.BP.GPM.DeptEmp de = null;
			com.kong.kflowweb.BP.Port.Emp emp = null;
			com.kong.kflowweb.BP.WF.Port.EmpStations ess = new com.kong.kflowweb.BP.WF.Port.EmpStations(stid);

			com.kong.kflowweb.BP.GPM.DeptEmps des = new com.kong.kflowweb.BP.GPM.DeptEmps();
			des.Retrieve(com.kong.kflowweb.BP.GPM.DeptEmpAttr.FK_Dept, deptid);

			com.kong.kflowweb.BP.Port.Emps emps = new com.kong.kflowweb.BP.Port.Emps();
			emps.RetrieveAll();

			for (com.kong.kflowweb.BP.WF.Port.EmpStation es : ess.ToJavaList())
			{
				Object tempVar = des.GetEntityByKey(com.kong.kflowweb.BP.GPM.DeptEmpAttr.FK_Emp, es.getFK_Emp());
				de = (com.kong.kflowweb.BP.GPM.DeptEmp)((tempVar instanceof com.kong.kflowweb.BP.GPM.DeptEmp) ? tempVar : null);
				...
				emp = (com.kong.kflowweb.BP.Port.Emp)((tempVar2 instanceof com.kong.kflowweb.BP.Port.Emp) ? tempVar2 : null);
		...
		{
			com.kong.kflowweb.BP.GPM.Emp emp = null;
			com.kong.kflowweb.BP.GPM.Emps emps = new com.kong.kflowweb.BP.GPM.Emps();
			emps.RetrieveAll();

			com.kong.kflowweb.BP.GPM.DeptEmpStations dess = new com.kong.kflowweb.BP.GPM.DeptEmpStations();
			dess.Retrieve(com.kong.kflowweb.BP.GPM.DeptEmpStationAttr.FK_Dept, deptid, com.kong.kflowweb.BP.GPM.DeptEmpStationAttr.FK_Station, stid);

			for (com.kong.kflowweb.BP.GPM.DeptEmpStation des : dess.ToJavaList())
			{
				Object tempVar3 = emps.GetEntityByKey(des.getFK_Emp());
				emp = (com.kong.kflowweb.BP.GPM.Emp)((tempVar3 instanceof com.kong.kflowweb.BP.GPM.Emp) ? tempVar3 : null);
	...
	public final String GetStructureTreeRootTable() throws Exception
	{
		...
		{
			com.kong.kflowweb.BP.WF.Port.AdminEmp aemp = new AdminEmp();
		...
		if (com.kong.kflowweb.BP.WF.Glo.getOSModel() == OSModel.OneOne)
		{
			com.kong.kflowweb.BP.WF.Port.Dept dept = new com.kong.kflowweb.BP.WF.Port.Dept();

			if (!StringHelper.isNullOrEmpty(newRootId))
			{
				if (dept.Retrieve(com.kong.kflowweb.BP.WF.Port.DeptAttr.No, newRootId) == 0)
				{
					dept.setNo("-1");
					dept.setName("无部门");
					dept.setParentNo("");
			...
			{
				if (dept.Retrieve(com.kong.kflowweb.BP.WF.Port.DeptAttr.ParentNo, parentrootid) == 0)
				{
					dept.setNo("-1");
					dept.setName("无部门");
					dept.setParentNo("");
		...
		{
			com.kong.kflowweb.BP.GPM.Dept dept = new com.kong.kflowweb.BP.GPM.Dept();

			if (!StringHelper.isNullOrEmpty(newRootId))
			{
				if (dept.Retrieve(com.kong.kflowweb.BP.GPM.DeptAttr.No, newRootId) == 0)
				{
					dept.setNo("-1");
					dept.setName("无部门");
					dept.setParentNo("");
			...
			{
				if (dept.Retrieve(com.kong.kflowweb.BP.GPM.DeptAttr.ParentNo, parentrootid) == 0)
				{
					dept.setNo("-1");
					dept.setName("无部门");
					dept.setParentNo("");
	...
	*/
	public final String GetSubDeptsTable() throws Exception
	{
		...
		String rootid = getRequest().getParameter("rootid");
			...
			depts.Retrieve(com.kong.kflowweb.BP.GPM.DeptAttr.ParentNo, rootid);
			com.kong.kflowweb.BP.GPM.Stations sts = new com.kong.kflowweb.BP.GPM.Stations();
			sts.RetrieveAll();
			com.kong.kflowweb.BP.GPM.DeptStations dss = new com.kong.kflowweb.BP.GPM.DeptStations();
			dss.Retrieve(com.kong.kflowweb.BP.GPM.DeptStationAttr.FK_Dept, rootid);
			com.kong.kflowweb.BP.GPM.DeptEmps des = new com.kong.kflowweb.BP.GPM.DeptEmps();
			des.Retrieve(com.kong.kflowweb.BP.GPM.DeptEmpAttr.FK_Dept, rootid);
			com.kong.kflowweb.BP.GPM.DeptEmpStations dess = new com.kong.kflowweb.BP.GPM.DeptEmpStations();
			dess.Retrieve(com.kong.kflowweb.BP.GPM.DeptEmpStationAttr.FK_Dept, rootid);
			com.kong.kflowweb.BP.GPM.Station stt = null;
			com.kong.kflowweb.BP.GPM.Emp emp = null;
			java.util.ArrayList<String> inemps = new java.util.ArrayList<String>();

			for (com.kong.kflowweb.BP.GPM.Dept dept : depts.ToJavaList())
			{
				//增加部门
			...
			//增加部门岗位
			for (com.kong.kflowweb.BP.GPM.DeptStation ds : dss.ToJavaList())
			{
				Object tempVar = sts.GetEntityByKey(ds.getFK_Station());
				stt = (com.kong.kflowweb.BP.GPM.Station)((tempVar instanceof com.kong.kflowweb.BP.GPM.Station) ? tempVar : null);
			...
			//增加没有岗位的人员
			for (com.kong.kflowweb.BP.GPM.DeptEmp de : des.ToJavaList())
			{
				if (dess.GetEntityByKey(com.kong.kflowweb.BP.GPM.DeptEmpStationAttr.FK_Emp, de.getFK_Emp()) == null)
				{
			...
			{
				emp = new com.kong.kflowweb.BP.GPM.Emp(inemp);
	...
	*/
	public final String Default_Init() throws Exception
	{
		if(!"BP".equals(SystemConfig.getRunOnPlant())) {
			com.kong.kflowweb.BP.Web.WebUser.getNo(); //启动设计器，先SSO登录，防止初次访问报错
		}
		
		//让admin登录
		if (DataType.IsNullOrEmpty(com.kong.kflowweb.BP.Web.WebUser.getNoOfRel())==true)
		{
			 
			 String userNo = this.GetRequestVal("UserNo");            
             String sid = this.GetRequestVal("SID");
             
             com.kong.kflowweb.BP.WF.Dev2Interface.Port_Login(userNo, sid);
             
		   return "url@Login.htm?DoType=Logout";
		}

		if (com.kong.kflowweb.BP.Web.WebUser.getIsAdmin() == false)
		{
			return "url@Login.htm?DoType=Logout";
		}
		...
		if (com.kong.kflowweb.BP.DA.DBAccess.IsExitsObject("WF_Flow") == false)
		{
		...
		try
		{
			// 执行升级
			String str;
			str = com.kong.kflowweb.BP.WF.Glo.UpdataCCFlowVer();
			if (str == null)
			{
				str = "";
			}
	...
	*/
	public final String Login_Init() throws Exception
	{
         ...
         {
             // 执行升级
             String str = com.kong.kflowweb.BP.WF.Glo.UpdataCCFlowVer();
             if (str == null)
                 str = "ccbpm 准备完毕,欢迎登录.";
             return str;
         }
	...
	public String Login_Submit() throws Exception
	{
         ...
         //判断集成的平台.
         String plant=com.kong.kflowweb.BP.Sys.SystemConfig.getRunOnPlant();
         ...
         //让其登录.
         com.kong.kflowweb.BP.WF.Dev2Interface.Port_Login(emp.getNo());
	...
	*/
	public final String SaveOneFlow() throws Exception
	{
		...
		//直接保存流程图信息
		com.kong.kflowweb.BP.WF.Flow fl = new com.kong.kflowweb.BP.WF.Flow(flowNo);
		//修改版本
		fl.setDType(fl.getDType() == com.kong.kflowweb.BP.WF.CCBPM_DType.BPMN.getValue() ? com.kong.kflowweb.BP.WF.CCBPM_DType.BPMN.getValue() : com.kong.kflowweb.BP.WF.CCBPM_DType.CCBPM.getValue());
	...
	*/
	...
	{
		com.kong.kflowweb.BP.WF.Flow flow = new com.kong.kflowweb.BP.WF.Flow();
	...
	*/
	public final String CreateNode() throws Exception
	{
		try
		{
			...
			int nodeId = com.kong.kflowweb.BP.WF.Template.TemplateGlo.NewNode(FK_Flow, iX, iY);

			com.kong.kflowweb.BP.WF.Node node = new com.kong.kflowweb.BP.WF.Node(nodeId);
	...
	/** 
	 ...
	 @return 
	*/
	public final com.kong.kflowweb.BP.WF.RunModel Node_GetRunModelByFigureName(String figureName)
	{
		com.kong.kflowweb.BP.WF.RunModel runModel = com.kong.kflowweb.BP.WF.RunModel.Ordinary;
		if (figureName.equals("NodeOrdinary"))
		{
				runModel = com.kong.kflowweb.BP.WF.RunModel.Ordinary;
		}
		else if (figureName.equals("NodeFL"))
		{
				runModel = com.kong.kflowweb.BP.WF.RunModel.FL;
		}
		else if (figureName.equals("NodeHL"))
		{
				runModel = com.kong.kflowweb.BP.WF.RunModel.HL;
		}
		else if (figureName.equals("NodeFHL"))
		{
				runModel = com.kong.kflowweb.BP.WF.RunModel.FHL;
		}
		else if (figureName.equals("NodeSubThread"))
		{
				runModel = com.kong.kflowweb.BP.WF.RunModel.SubThread;
		}
		else
		{
				runModel = com.kong.kflowweb.BP.WF.RunModel.Ordinary;
	...
	*/
	public final String Node_ChangeRunModel() throws Exception
	{
		...
		com.kong.kflowweb.BP.WF.Node node = new com.kong.kflowweb.BP.WF.Node(this.getFK_Node());
		//节点运行模式
		if (runModel.equals("NodeOrdinary"))
		{
				node.setHisRunModel(com.kong.kflowweb.BP.WF.RunModel.Ordinary);
		}
		else if (runModel.equals("NodeFL"))
		{
				node.setHisRunModel(com.kong.kflowweb.BP.WF.RunModel.FL);
		}
		else if (runModel.equals("NodeHL"))
		{
				node.setHisRunModel(com.kong.kflowweb.BP.WF.RunModel.HL);
		}
		else if (runModel.equals("NodeFHL"))
		{
				node.setHisRunModel(com.kong.kflowweb.BP.WF.RunModel.FHL);
		}
		else if (runModel.equals("NodeSubThread"))
		{
				node.setHisRunModel(com.kong.kflowweb.BP.WF.RunModel.SubThread);
		}
		node.Update();
	...
	*/
	public final String GetWebUserInfo() throws Exception
	{
		...
		com.kong.kflowweb.BP.Port.Emp emp = new com.kong.kflowweb.BP.Port.Emp(WebUser.getNo());
	   ...
	   public String GetTreeJson_AdminMenu() throws Exception
       {
		   ...
		   AdminMenus menus = new AdminMenus();
            ...
            return com.kong.kflowweb.BP.Tools.Json.ToJson(newMenus.ToDataTable());
       }
	...
	*/
	...
	{
		String sql = "SELECT * FROM (SELECT 'F'+No NO,'F'+ParentNo PARENTNO, NAME, IDX, 1 ISPARENT,'FLOWTYPE' TTYPE,-1 DTYPE FROM WF_FlowSort" + "\r\n" + "                           union " + "\r\n" + "                           SELECT NO, 'F'+FK_FlowSort as PARENTNO,(NO + '.' + NAME) NAME,IDX,0 ISPARENT,'FLOW' TTYPE,DTYPE FROM WF_Flow) A  ORDER BY DTYPE, IDX";

		if (com.kong.kflowweb.BP.Sys.SystemConfig.getAppCenterDBType() == DBType.Oracle)
		{
			sql = "SELECT * FROM (SELECT 'F'||No NO,'F'||ParentNo PARENTNO,NAME, IDX, 1 ISPARENT,'FLOWTYPE' TTYPE,-1 DTYPE FROM WF_FlowSort" + "\r\n" + "                        union " + "\r\n" + "                        SELECT NO, 'F'||FK_FlowSort as PARENTNO,NO||'.'||NAME NAME,IDX,0 ISPARENT,'FLOW' TTYPE,0 as DTYPE FROM WF_Flow) A  ORDER BY DTYPE, IDX";
		}
		else if (com.kong.kflowweb.BP.Sys.SystemConfig.getAppCenterDBType() == DBType.MySQL)
		{
			sql = "SELECT * FROM (SELECT CONCAT('F', No) NO, CONCAT('F', ParentNo) PARENTNO, NAME, IDX, 1 ISPARENT,'FLOWTYPE' TTYPE,-1 DTYPE FROM WF_FlowSort" + "\r\n" + "                           union " + "\r\n" + "                           SELECT NO, CONCAT('F', FK_FlowSort) PARENTNO, CONCAT(NO, '.', NAME) NAME,IDX,0 ISPARENT,'FLOW' TTYPE,DTYPE FROM WF_Flow) A  ORDER BY DTYPE, IDX";
		}
	...
	public final String GetFormTreeTable() throws Exception
	{
         ...
         //增加顶级类别..
          ...
          String str= com.kong.kflowweb.BP.Tools.Json.ToJson(dtForm);
         // com.kong.kflowweb.BP.DA.DataType.WriteFile("C:\\TreeJflow.txt", str);
          return str; 
	}
	...
	public final String GetStructureTreeTable() throws Exception
	{
		...
		if (com.kong.kflowweb.BP.WF.Glo.getOSModel() == OSModel.OneOne)
		{
			com.kong.kflowweb.BP.WF.Port.Depts depts = new com.kong.kflowweb.BP.WF.Port.Depts();
			depts.RetrieveAll();
			com.kong.kflowweb.BP.WF.Port.Stations sts = new com.kong.kflowweb.BP.WF.Port.Stations();
			sts.RetrieveAll();
			com.kong.kflowweb.BP.WF.Port.Emps emps = new com.kong.kflowweb.BP.WF.Port.Emps();
			emps.RetrieveAll(com.kong.kflowweb.BP.WF.Port.EmpAttr.Name);
			com.kong.kflowweb.BP.WF.Port.EmpStations empsts = new com.kong.kflowweb.BP.WF.Port.EmpStations();
			empsts.RetrieveAll();
			com.kong.kflowweb.BP.GPM.DeptEmps empdetps = new com.kong.kflowweb.BP.GPM.DeptEmps();
			...
			com.kong.kflowweb.BP.WF.Port.Station stt = null;
			com.kong.kflowweb.BP.WF.Port.Emp empt = null;

			for (com.kong.kflowweb.BP.WF.Port.Dept dept : depts.ToJavaList())
			{
				//增加部门
				dt.Rows.AddDatas(dept.getNo(), dept.getParentNo(), dept.getName(), "DEPT");
				...
				//获取部门下的岗位
				empdetps.Retrieve(com.kong.kflowweb.BP.GPM.DeptEmpAttr.FK_Dept, dept.getNo());
				for (com.kong.kflowweb.BP.GPM.DeptEmp empdept : empdetps.ToJavaList())
				{
					des.get(dept.getNo()).add(empdept.getFK_Emp());
					//判断该人员拥有的岗位
					empsts.Retrieve(com.kong.kflowweb.BP.WF.Port.EmpStationAttr.FK_Emp, empdept.getFK_Emp());
					for (com.kong.kflowweb.BP.WF.Port.EmpStation es : empsts.ToJavaList())
					{
						...
						if (dss.get(dept.getNo()).contains(es.getFK_Station()) == false)
						{
							...
							stt = (com.kong.kflowweb.BP.WF.Port.Station)((tempVar instanceof com.kong.kflowweb.BP.WF.Port.Station) ? tempVar : null);
			...
			for (java.util.Map.Entry<String, java.util.ArrayList<String>> ds : dss.entrySet())
			{
				for (String st : ds.getValue())
				{
					for (String emp : ses.get(st))
					{
						...
						empt = (com.kong.kflowweb.BP.WF.Port.Emp)((tempVar2 instanceof com.kong.kflowweb.BP.WF.Port.Emp) ? tempVar2 : null);
		...
		else
		{
			...
			dess.RetrieveAll();
			com.kong.kflowweb.BP.GPM.Station stt = null;
			com.kong.kflowweb.BP.GPM.Emp empt = null;
			...
			for (com.kong.kflowweb.BP.GPM.Dept dept : depts.ToJavaList())
			{
				...
				//增加部门岗位
				dss.Retrieve(com.kong.kflowweb.BP.GPM.DeptStationAttr.FK_Dept, dept.getNo());
				for (com.kong.kflowweb.BP.GPM.DeptStation ds : dss.ToJavaList())
				{
					Object tempVar3 = sts.GetEntityByKey(ds.getFK_Station());
					stt = (com.kong.kflowweb.BP.GPM.Station)((tempVar3 instanceof com.kong.kflowweb.BP.GPM.Station) ? tempVar3 : null);
					...
					//增加部门岗位人员
					dess.Retrieve(com.kong.kflowweb.BP.GPM.DeptEmpStationAttr.FK_Dept, dept.getNo(), com.kong.kflowweb.BP.GPM.DeptEmpStationAttr.FK_Station, ds.getFK_Station());

					for (com.kong.kflowweb.BP.GPM.DeptEmpStation des : dess.ToJavaList())
					{
						Object tempVar4 = emps.GetEntityByKey(des.getFK_Emp());
						empt = (com.kong.kflowweb.BP.GPM.Emp)((tempVar4 instanceof com.kong.kflowweb.BP.GPM.Emp) ? tempVar4 : null);
	...
	*/
	...
	public final String NewFlow()
	{
		try
		{
			...
			String flowNo = com.kong.kflowweb.BP.WF.Template.TemplateGlo.NewFlow(fk_floSort, flowName, dataSaveModel, pTable, flowMark, flowVer);
	...
	public final String DelNode() throws Exception
	{
		try
		{
			com.kong.kflowweb.BP.WF.Node nd = new com.kong.kflowweb.BP.WF.Node();
	...
	public final String GetFlowSorts() throws Exception
	{
		...
		com.kong.kflowweb.BP.WF.Port.AdminEmp emp = new AdminEmp(com.kong.kflowweb.BP.Web.WebUser.getNo());

		return com.kong.kflowweb.BP.Tools.Entitis2Json.ConvertEntitis2GenerTree(flowSorts, emp.getRootOfFlow());
	}
	/** 
	 删除流程类别.
	...
	*/
	public final String LetAdminLogin(String empNo, boolean islogin) throws Exception
	{
		try
		{
			if (islogin)
			{
				com.kong.kflowweb.BP.Port.Emp emp = new com.kong.kflowweb.BP.Port.Emp(empNo);
	...
	{
		com.kong.kflowweb.BP.WF.Flow fl = new com.kong.kflowweb.BP.WF.Flow(this.getFK_Flow());
