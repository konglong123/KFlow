	...
	*/
	public final int GetMsgsCountByEmpID(int empId)
	{
		...
		if (newMsgNum > 0)
		{
			...
			//    System.Web.HttpContext.Current.Response.Write("<bgsound src='"+com.kong.kflowweb.BP.Sys.Glo.Request.ApplicationPath+Web.WebUser.NoticeSound+"' loop=1 >"  );
			//if (WebUser.IsTextAlert)
			//    com.kong.kflowweb.BP.Sys.PubClass.ResponseWriteBlueMsg("您有["+newMsgNum+"]个新工作." );
			//System.Web.HttpContext.Current.Response.Write("<bgsound src='"+com.kong.kflowweb.BP.Sys.Glo.Request.ApplicationPath+Web.WebUser.NoticeSound+"' loop=1 >"  );
