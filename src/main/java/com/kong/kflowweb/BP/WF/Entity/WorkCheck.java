...
public class WorkCheck
{
	...
	public final int GetMyPK32()
	{
		try
		{
			...
			DataTable dt = com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(String.format(sql,
	...
	public final Tracks getHisWorkChecks() throws Exception
	{
		if (_HisWorkChecks == null)
		{
			...
			com.kong.kflowweb.BP.En.Attrs attrs = _HisWorkChecks.getGetNewEntity().getEnMap()
					.getAttrs();
