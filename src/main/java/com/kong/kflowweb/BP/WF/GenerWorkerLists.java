...
public class GenerWorkerLists extends Entities
{
	...
	*/
	public GenerWorkerLists(long workId, int nodeId, boolean isWithEmpExts) throws Exception
	{
		...
		rm.setFK_Emp(com.kong.kflowweb.BP.Web.WebUser.getNo());
	...
	*/
	...
	/** 
	 ...
	 @return List
	*/
	public final java.util.ArrayList<com.kong.kflowweb.BP.WF.GenerWorkerList> Tolist()
	{
		java.util.ArrayList<com.kong.kflowweb.BP.WF.GenerWorkerList> list = new java.util.ArrayList<com.kong.kflowweb.BP.WF.GenerWorkerList>();
		for (int i = 0; i < this.size(); i++)
		{
			list.add((com.kong.kflowweb.BP.WF.GenerWorkerList)this.get(i));
		}
		return list;
	}
}