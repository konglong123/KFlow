...
import com.kong.kflowweb.BP.WF.CCRole;
import com.kong.kflowweb.BP.WF.HuiQianRole;
import com.kong.kflowweb.BP.WF.JumpWay;
import com.kong.kflowweb.BP.WF.Node;
import com.kong.kflowweb.BP.WF.SubFlowCtrlRole;
...
public class BtnLab extends Entity
{
	...
	*/
	public final String getSendJS()
	{
		...
		if (this.getCCRole() == com.kong.kflowweb.BP.WF.CCRole.WhenSend)
		{
