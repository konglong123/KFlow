...
{
//	private String corpid = com.kong.kflowweb.BP.Sys.SystemConfig.Ding_CorpID;
//	private String corpsecret = com.kong.kflowweb.BP.Sys.SystemConfig.Ding_CorpSecret;
//
...
//		{
//			com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineError(ex.getMessage());
//		}
//		return accessToken;
//	}
//
...
//			//com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineError(access_token + "1." + user.userid + "2." + user.errcode + "3." + user.errmsg);
...
//
//				///#region 处理部门名称全程
//				com.kong.kflowweb.BP.WF.DTS.OrgInit_NameOfPath nameOfPath = new com.kong.kflowweb.BP.WF.DTS.OrgInit_NameOfPath();
...
//
//			String str = com.kong.kflowweb.BP.Tools.FormatToJson.ToJson_FromDictionary(list);
...
//				{
//					com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineError("钉钉新增部门失败：" + postVal.geterrcode() + "-" + postVal.geterrmsg());
//				}
//
//				return postVal;
//			}
...
//				if (!postVal.geterrcode().equals("0"))
//				{
//					com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineError("钉钉修改部门失败：" + postVal.geterrcode() + "-" + postVal.geterrmsg());
//				}
//
//				return postVal;
//			}
...
//				if (!postVal.geterrcode().equals("0"))
//				{
//					com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineError("钉钉删除部门失败：" + postVal.geterrcode() + "-" + postVal.geterrmsg());
//				}
//
//				return postVal;
//			}
...
//					}
//					com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineError("钉钉新增人员失败：" + postVal.geterrcode() + "-" + postVal.geterrmsg());
//				}
//				return postVal;
//			}
//		}
...
//				if (!postVal.geterrcode().equals("0"))
//				{
//					com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineError("钉钉修改人员失败：" + postVal.geterrcode() + "-" + postVal.geterrmsg());
//				}
//				return postVal;
//			}
//		}
...
//				if (!postVal.geterrcode().equals("0"))
//				{
//					com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineError("钉钉删除人员失败：" + postVal.geterrcode() + "-" + postVal.geterrmsg());
//				}
//
//				return postVal;
//			}
...
//	{
//		//人员
//		com.kong.kflowweb.BP.DA.DBAccess.RunSQL("DELETE FROM Port_Emp");
//		//部门
//		com.kong.kflowweb.BP.DA.DBAccess.RunSQL("DELETE FROM Port_Dept");
//		//部门人员
//		com.kong.kflowweb.BP.DA.DBAccess.RunSQL("DELETE FROM Port_DeptEmp");
//		//部门人员岗位
//		com.kong.kflowweb.BP.DA.DBAccess.RunSQL("DELETE FROM Port_DeptEmpStation");
//		//admin 是必须存在的
//		Emp emp = new Emp();
//		emp.getNo() = "admin";
//		emp.Pass = "pub";
