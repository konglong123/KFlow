package com.kong.kflowweb.BP.Rpt;
...
public class Rpt2Attr
{
	...
	public final String getTitle() throws Exception
	{
		...
		ArrayList<String> keys = com.kong.kflowweb.BP.Sys.Glo.getQueryStringKeys();
	...
	public final DataTable getDBDataTable() throws Exception
	{
		if (_DBDataTable == null)
		{
			...
			{
				com.kong.kflowweb.BP.DA.AtPara ap = new com.kong.kflowweb.BP.DA.AtPara(this.DefaultParas);
			...
			_DBDataTable = com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(sql);
		}
		return _DBDataTable;
	}
