...
public class Entitis2Json
{
	 ...
	 * @return
	 */
	public final String TranslateEntitiesToListJson(com.kong.kflowweb.BP.En.Entities ens,
			String hidenKeys)
	{
	 ...
	 * @return
	 */
	public final String TranslateEntitiesToGridJsonOnlyData(com.kong.kflowweb.BP.En.Entities ens,
			int totalRows, String hidenKeys)
	{
		Attrs attrs = ens.getGetNewEntity().getEnMap().getAttrs();
		StringBuilder append = new StringBuilder();
