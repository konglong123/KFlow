...
public abstract class HttpHandlerBase
{
	 ...
	 * 注意： "Handler业务处理类"必须继承自com.kong.kflowweb.BP.WF.HttpHandler.WebContralBase</p>
	*/
	...
	{	
		...
		com.kong.kflowweb.BP.DA.Log.DebugWriteInfo(msg);
	//	out.write(msg);
		...
		catch (Exception ex)
		{
			...
			com.kong.kflowweb.BP.DA.Log.DebugWriteError(err);
