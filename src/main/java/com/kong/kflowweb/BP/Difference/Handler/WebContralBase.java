...
import com.kong.kflowweb.BP.Sys.Glo;
import com.kong.kflowweb.BP.Sys.SystemConfig;
import com.kong.kflowweb.BP.Sys.UIConfig;
...
public abstract class WebContralBase {
	...
	public final String DoMethod(WebContralBase myEn, String methodName) throws Exception {
		...
		try {
			...
			Log.DebugWriteError("com.kong.kflowweb.BP.WF.HttpHangerBase.DoMethod()" + errInfo);
			return errInfo;
	...
	protected String ExportDGToExcel(DataSet ds,  String title,String params) throws Exception {
		...
		String fileDir = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfTemp();
		String filePth = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfTemp();
		// 参数及变量设置
		// 如果导出目录没有建立，则建立.
		...
		cell.setCellValue("制表人：" + WebUser.getName() + "日期：" + com.kong.kflowweb.BP.DA.DataType.getCurrentDataTimeCNOfShort());
	...
	protected String ExportDGToExcel(DataTable dt, Entity en, String title, Attrs mapAttrs) throws Exception {
		...
		String fileName = title + "_" + com.kong.kflowweb.BP.DA.DataType.getCurrentDataCNOfLong() + "_" + WebUser.getNo() + ".xls";
		String fileDir = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfTemp();
		String filePth = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfTemp();
		// 参数及变量设置
		// 如果导出目录没有建立，则建立.
	 ...
	 * download) {
	 * 
	 * String file = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfTemp() + filename;
	 * 
	 * String dir = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfTemp(); String name = filename;
