...
//		}
	...
	public static boolean isLoggerDebugEnabled() {
	    ...
	    return com.kong.kflowweb.BP.Sys.SystemConfig.getIsDebug();
	...
	// {
	// String file = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfLog();
	// try
	// {
	...
	// {
	// String file = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfLog() + new
