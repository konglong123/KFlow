...
public class RefMethod
{
	 ...
	 * 功能
	 */
	public RefMethodType refMethodType= com.kong.kflowweb.BP.En.RefMethodType.Func;
	/*
...
//			System.out.println(mps[i].getName());
		 ...
		 * com.kong.kflowweb.BP.Sys.Glo.Request.QueryString["No"]; // //if (val == null) // //{ //
		 * // val = com.kong.kflowweb.BP.Sys.Glo.Request.QueryString["PK"]; // //} //
		 * this.HisEn.PKVal = com.kong.kflowweb.BP.Sys.Glo.Request.QueryString[this.HisEn.PK]; //}
