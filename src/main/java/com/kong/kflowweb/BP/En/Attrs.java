...
public class Attrs extends ArrayList<Attr>
{
		...
		for (String str : strs)
		{
			...
			switch (ft)
			{
				case Enum:
					...
					break;
				case FK:
					EntitiesNoName ens = (EntitiesNoName)com.kong.kflowweb.BP.En.ClassFactory.GetEns(ap.GetValStrByKey("BindKey"));
	 ...
	 * @return
	 */
	public final com.kong.kflowweb.BP.Sys.MapAttrs ToMapAttrs()
	{		
        ...
        for (Attr item : this)
        {
            ...
            com.kong.kflowweb.BP.Sys.MapAttr mattr = new com.kong.kflowweb.BP.Sys.MapAttr();
