...
public class Map
{
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.Sys.CField.GetMyAttrs(en.getGetNewEntities(), en.getEnMap());
	}
	
	public final Attrs GetChoseAttrs(Entities ens)
	{
		return com.kong.kflowweb.BP.Sys.CField.GetMyAttrs(ens, this);
	}
	...
	public com.kong.kflowweb.BP.Sys.DTSearchWay DTSearchWay = com.kong.kflowweb.BP.Sys.DTSearchWay.None;
