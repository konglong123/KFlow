...
public class UAC
{
    ...
    {
        String sql = "SELECT Tag1  FROM V_GPM_EmpMenu WHERE  FK_Emp='"+com.kong.kflowweb.BP.Web.WebUser.getNo()+"'  AND Url LIKE '%" + en.toString()+ "%'  ";
        DataTable dt = DBAccess.RunSQLReturnTable(sql);
        for (com.kong.kflowweb.BP.DA.DataRow dr : dt.Rows)
        {
