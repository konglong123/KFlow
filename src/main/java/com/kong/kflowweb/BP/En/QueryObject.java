...
import com.kong.kflowweb.BP.DA.GroupWay;
import com.kong.kflowweb.BP.DA.OrderWay;
import com.kong.kflowweb.BP.DA.Para;
...
public class QueryObject {
	...
	public com.kong.kflowweb.BP.DA.DBType HisDBType = DBType.MSSQL;
	public com.kong.kflowweb.BP.DA.DBUrlType HisDBUrlType = DBUrlType.AppCenterDSN;
	 ...
	 *            长度
	 */
	public final void AddWhereLen(String attr, String exp, int len, com.kong.kflowweb.BP.DA.DBType dbtype) {
		this.setSQL("( " + com.kong.kflowweb.BP.Sys.SystemConfig.getAppCenterDBLengthStr() + "( " + attr2Field(attr) + " ) " + exp + " '"
