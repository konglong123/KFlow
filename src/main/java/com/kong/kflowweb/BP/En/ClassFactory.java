...
import com.kong.kflowweb.BP.Sys.EventBase;
...
import com.kong.kflowweb.BP.Tools.ClassUtils;
...
public class ClassFactory {
	 ...
	 * @param className
	 *            类名称
	 * @return com.kong.kflowweb.BP.Sys.EventBase
	 */
	public static com.kong.kflowweb.BP.Sys.EventBase GetEventBase(String className) {
		if (Htable_Evbase == null || Htable_Evbase.isEmpty()) {
			Htable_Evbase = new Hashtable();
			String cl = "com.kong.kflowweb.BP.Sys.EventBase";
		...
		com.kong.kflowweb.BP.Sys.EventBase ens = (EventBase) ((Htable_Evbase.get(className) instanceof EventBase)
	...
	public static Entity GetEn(String className) {
		...
		if (Htable_En == null) {
			...
			String cl = "com.kong.kflowweb.BP.En.Entity";
			ArrayList al = ClassFactory.GetObjects(cl);
			for (Object en : al) {
	...
	public static Method GetMethod(String className) {
		if (Htable_Method == null) {
			...
			String cl = "com.kong.kflowweb.BP.En.Method";
		...
		return ((com.kong.kflowweb.BP.En.Method) ((tmp instanceof com.kong.kflowweb.BP.En.Method) ? tmp : null));
	}
	...
	public static Entities GetEns(String className) {
		...
		if (className.contains(".") == false) {
			com.kong.kflowweb.BP.Sys.GEEntitys myens = new com.kong.kflowweb.BP.Sys.GEEntitys(className);
			return myens;
		}

		// if (Htable_Ens == null || Htable_Ens.isEmpty()) {
		Htable_Ens = new Hashtable<String, Object>();
		String cl = "com.kong.kflowweb.BP.En.Entities";
		ArrayList al = ClassFactory.GetObjects(cl);
	 ...
	 * @return En
	 */
	public static com.kong.kflowweb.BP.XML.XmlEns GetXmlEns(String className) {
		if (Htable_XmlEns == null) {
			Htable_XmlEns = new Hashtable<String, Object>();
			String cl = "com.kong.kflowweb.BP.XML.XmlEns";
			ArrayList al = ClassFactory.GetObjects(cl);
			for (Object en : al) {
		...
		return ((com.kong.kflowweb.BP.XML.XmlEns) ((tmp instanceof com.kong.kflowweb.BP.XML.XmlEns) ? tmp : null));
	}
	 ...
	 * @return En
	 */
	public static com.kong.kflowweb.BP.XML.XmlEn GetXmlEn(String className) {
		if (Htable_XmlEn == null) {
			Htable_XmlEn = new Hashtable<String, Object>();
			String cl = "com.kong.kflowweb.BP.XML.XmlEn";
			ArrayList al = ClassFactory.GetObjects(cl);
			for (Object en : al) {
		...
		return ((com.kong.kflowweb.BP.XML.XmlEn) ((tmp instanceof com.kong.kflowweb.BP.XML.XmlEn) ? tmp : null));
	}
	...
	public static Object GetHandlerPage(String className) {
		...
		if (Htable_HandlerPage == null) {
			...
			String cl = "com.kong.kflowweb.BP.WF.HttpHandler.DirectoryPageBase";
			ArrayList al = ClassFactory.GetObjects(cl);
			for (Object en : al) {
				String key = "";
