...
public abstract class Entities extends ArrayList<Entity>
{
	...
	public final int FlodInCash() throws Exception
	{
		...
		com.kong.kflowweb.BP.DA.Log.DefaultLogWriteLineInfo("成功[" + en.toString() + "-" + num
				+ "]放入缓存。");
		return num;
	}
	...
	{
		this.clear();
		com.kong.kflowweb.BP.En.Entities tempVar = Cash.GetEnsDataExt(cashKey);
	...
	{
		return com.kong.kflowweb.BP.Tools.Json.ToJson(this.ToDataTableField(dtName));
	}
