...
import com.kong.kflowweb.BP.Sys.UploadFileNumCheck;
...
public class FrmAttachmentExt extends EntityMyPK {
	...
	public UAC getHisUAC() throws Exception {
		...
		uac.IsView = true;
		uac.IsInsert = false;
		if (com.kong.kflowweb.BP.Web.WebUser.getNo().equals("admin") || com.kong.kflowweb.BP.Web.WebUser.getIsAdmin()) {
			uac.IsUpdate = true;
			uac.IsDelete = true;
			return uac;
		}
	...
	public String DoTestFTPHost() {
		FtpUtil ftpUtil;
		try {
			ftpUtil = com.kong.kflowweb.BP.WF.Glo.getFtpUtil();
		} catch (Exception e) {
