...
public class SysDocFile extends EntityMyPK
{
	...
	public static String GetValHtmlV2(String enName, String pkVal)
	{
		try
		{
			return com.kong.kflowweb.BP.DA.DataType.ReadTextFile(com.kong.kflowweb.BP.Sys.SystemConfig
	...
	// try
	// {
	// return com.kong.kflowweb.BP.DA.DataType.ReadTextFile(com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfFDB() +
	// enName + "\\" + pkVal + ".fdb");
	// }
	// catch (java.lang.Exception e)
	// {
	...
	public static void SetValV2(String enName, String pkVal, String val)
	{
		try
		{
			String dir = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfFDB() + enName + "\\";
			...
			com.kong.kflowweb.BP.DA.DataType.SaveAsFile(dir + "\\" + pkVal + ".fdb", val);
		} catch (RuntimeException ex)
		{
			String filePath = com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfFDB() + enName;
	...
	public final void UpdateLoadFileOfAccess(String FileName)
	{
		...
		// (OleDbConnection)com.kong.kflowweb.BP.DA.DBAccess.GetAppCenterDBConn ;
		// conn.Open();
