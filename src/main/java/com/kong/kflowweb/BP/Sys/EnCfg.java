...
import com.kong.kflowweb.BP.En.EntityNo;
...
public class EnCfg extends EntityNo
{
	...
	public final String getFJSavePath()
	{
		...
		{
			return com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfDataUser() + this.getNo()
					+ "/";
		}
		return str;
	}
	...
	public final String getFJWebPath()
	{
		...
		{
			return com.kong.kflowweb.BP.Sys.Glo.getRequest().getRemoteHost() + "/DataUser/"
					+ this.getNo() + "/";
		}
		return str;
	}
