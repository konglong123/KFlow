...
import com.kong.kflowweb.BP.DA.DBCheckLevel;
...
public class PubClass {
	...
	public static void InitFrm(String fk_mapdata) throws Exception {
		// 删除数据.
		com.kong.kflowweb.BP.Sys.FrmLabs labs = new com.kong.kflowweb.BP.Sys.FrmLabs();
		try {
			labs.Delete(com.kong.kflowweb.BP.Sys.FrmLabAttr.FK_MapData, fk_mapdata);
		} catch (Exception e) {
			e.printStackTrace();
		}

		com.kong.kflowweb.BP.Sys.FrmLines lines = new com.kong.kflowweb.BP.Sys.FrmLines();
		try {
			lines.Delete(com.kong.kflowweb.BP.Sys.FrmLabAttr.FK_MapData, fk_mapdata);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		if (md.RetrieveFromDBSources() == 0) {
			com.kong.kflowweb.BP.Sys.MapDtl mdtl = new com.kong.kflowweb.BP.Sys.MapDtl();
		...
		com.kong.kflowweb.BP.Sys.MapAttrs mattrs = new com.kong.kflowweb.BP.Sys.MapAttrs(fk_mapdata);
		com.kong.kflowweb.BP.Sys.GroupFields gfs = new com.kong.kflowweb.BP.Sys.GroupFields(fk_mapdata);
		...
		int currX = 0;
		int currY = 0;
		com.kong.kflowweb.BP.Sys.FrmLab lab = new com.kong.kflowweb.BP.Sys.FrmLab();
		...
		// 表格头部的横线.
		currY += 20;
		com.kong.kflowweb.BP.Sys.FrmLine lin = new com.kong.kflowweb.BP.Sys.FrmLine();
		lin.setX1(0);
		lin.setX2(tableW);
		lin.setY1(currY);
		lin.setY2(currY);
		...
		for (Object gf : gfs) {
			i++;
			lab = new com.kong.kflowweb.BP.Sys.FrmLab();
			lab.setX(0);
			lab.setY(currY);
			...
			currY += 15;
			lin = new com.kong.kflowweb.BP.Sys.FrmLine();
	...
	public static String getKeyFields() {
		if (_KeyFields == null) {
			_KeyFields = com.kong.kflowweb.BP.DA.DataType.ReadTextFile(SystemConfig.getPathOfData() + "/Sys/FieldKeys.txt");
		}
		return _KeyFields;
	}
	...
	public static String GenerLabelStr(String title) {
		String path = com.kong.kflowweb.BP.Sys.Glo.getRequest().getRemoteHost();
	...
	public final String Chs2Pinyin(String str) {
		return com.kong.kflowweb.BP.Tools.chs2py.convert(str);
	}
	...
	public static String GenerTablePage(DataTable dt, String title) {
		...
		for (DataColumn dc : dt.Columns) {
			str += "<TD class='DGCellOfHeader" + com.kong.kflowweb.BP.Web.WebUser.getStyle() + "' nowrap >" + dc.ColumnName + "</TD>";
		}
		str += "</TR>";
	...
	public static String GenerTempFileName(String hz) throws Exception {
		...
		return com.kong.kflowweb.BP.Web.WebUser.getNo() + formatter.format(new Date()) + "." + hz;
	}
	...
	public static void ReCreateIndex() {
		java.util.ArrayList als = ClassFactory.GetObjects("com.kong.kflowweb.BP.En.Entity");
		String sql = "";
		for (Object obj : als) {
	...
	public static void DBIOToAccess() {
		java.util.ArrayList al = com.kong.kflowweb.BP.En.ClassFactory.GetObjects("com.kong.kflowweb.BP.En.Entities");
	 ...
	 * @return
	 */
	public static void DBIO(com.kong.kflowweb.BP.DA.DBType dbtype, java.util.ArrayList als, boolean creatTableOnly) {
		for (Object ens : als) {
	...
	public static DataTable GetDataTableByUIBineKey(String uiBindKey) throws Exception {
          ...
          {
              Entities ens = com.kong.kflowweb.BP.En.ClassFactory.GetEns(uiBindKey);
              if (ens == null)
                  ens = com.kong.kflowweb.BP.En.ClassFactory.GetEns(uiBindKey);
	...
	public static DataTable GetDataTableByUIBineKeyForCCFormDesigner(String uiBindKey) throws Exception {
		...
		if (uiBindKey.contains(".")) {
			...
			com.kong.kflowweb.BP.En.QueryObject qo = new QueryObject(ens);
	...
	public static String DBRpt(DBCheckLevel level) throws Exception {
		// 取出全部的实体
		java.util.ArrayList als = ClassFactory.GetObjects("com.kong.kflowweb.BP.En.Entities");
		String msg = "";
		for (Object obj : als) {
	...
	private static void AddCommentForTable_MySql(Entity en) throws Exception
	{
		 
		//MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(com.kong.kflowweb.BP.Sys.SystemConfig.AppCenterDSN);
		String database = com.kong.kflowweb.BP.Sys.SystemConfig.getAppCenterDBDatabase();
...
//		}
	 ...
	 * @return
	 */
	public static com.kong.kflowweb.BP.En.Entity copyFromRequest(com.kong.kflowweb.BP.En.Entity en, HttpServletRequest reqest) {
	...
	// {
	// System.Web.HttpContext.Current.Response.Redirect(com.kong.kflowweb.BP.Sys.Glo.getRequest().ApplicationPath+"/SignIn.jsp?url=/Wel.jsp");
	// }
	// public static void ToWelPage()
	// {
	// System.Web.HttpContext.Current.Response.Redirect(com.kong.kflowweb.BP.Sys.Glo.getRequest().ApplicationPath+"/Wel.jsp");
	// }
	/**
	 * 切换到信息也面。
	 * 
	...
	public static void ToErrorPage(String mess, HttpServletResponse response) {
		com.kong.kflowweb.BP.Sys.Glo.getRequest().getSession().setAttribute("info", mess);
		try {
			response.sendRedirect(com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Comm/Port/ToErrorPage.jsp?d=" + new Date());
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public static void ToMsgPage(String mess, HttpServletResponse response) {
		...
		com.kong.kflowweb.BP.Sys.Glo.getRequest().getSession().setAttribute("info", mess);
		try {
			response.sendRedirect(com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath() + "WF/Comm/Port/InfoPage.jsp?d=" + new Date());
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	//
	// String path = com.kong.kflowweb.BP.Sys.Glo.getRequest().ApplicationPath;
	// if (path.equals("/") || path.equals(""))
	// {
	// path = "";
	// }
	...
	public static com.kong.kflowweb.BP.En.Entity CopyFromRequest(com.kong.kflowweb.BP.En.Entity en) {
	...
	public static com.kong.kflowweb.BP.En.Entity CopyFromRequestByPost(com.kong.kflowweb.BP.En.Entity en, HttpServletRequest reqest) {
