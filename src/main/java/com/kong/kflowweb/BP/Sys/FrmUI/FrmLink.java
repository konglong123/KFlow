...
import com.kong.kflowweb.BP.Sys.FrmLabAttr;
import com.kong.kflowweb.BP.Sys.FrmLinkAttr;
...
public class FrmLink extends EntityMyPK
{
	...
	*/
	...
	@Override
     ...
     {
         com.kong.kflowweb.BP.Sys.FrmLink frmLink = new com.kong.kflowweb.BP.Sys.FrmLink();
