...
public class MapExt extends EntityMyPK
{
	...
	*/
	...
	{
		//return com.kong.kflowweb.BP.Tools.Json.ToJson(this.PopValToHashtable(), false);
		return com.kong.kflowweb.BP.Tools.Json.ToJsonEntityModel(this.PopValToHashtable());
	}
 ...
 * @throws Exception 
   */
	...
	public final String getTagOfSQL_autoFullTB() throws Exception
	{
		...
		sql = sql.replace("@WebUser.FK_DeptNameOfFull", com.kong.kflowweb.BP.Web.WebUser.getFK_DeptNameOfFull());
		sql = sql.replace("@WebUser.FK_DeptName", com.kong.kflowweb.BP.Web.WebUser.getFK_DeptName());
