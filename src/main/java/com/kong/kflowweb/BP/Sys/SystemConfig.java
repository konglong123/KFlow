...
public class SystemConfig {
	...
	public static String GetConfigXmlEns(String key, String ensName) {
		try {
			Object tempVar = com.kong.kflowweb.BP.DA.Cash.GetObj("TConfigEns", com.kong.kflowweb.BP.DA.Depositary.Application);
			DataTable dt = (DataTable) ((tempVar instanceof DataTable) ? tempVar : null);
			if (dt == null) {
				DataSet ds = new DataSet("dss");
				ds.readXml(com.kong.kflowweb.BP.Sys.SystemConfig.getPathOfXML() + "Ens/ConfigEns.xml");
				dt = ds.Tables.get(0);
				com.kong.kflowweb.BP.DA.Cash.AddObj("TConfigEns", com.kong.kflowweb.BP.DA.Depositary.Application, dt);
			}
	...
	public static Hashtable<String, Object> getCS_AppSettings() {
		...
		if (_CS_AppSettings == null || _CS_AppSettings.size() == 0) {
			try {
				...
				Properties props = com.kong.kflowweb.BP.Difference.Helper.loadResource();
	...
	public static String getPathOfData() {
		String str1=getPathOfWebApp();
		String str2=SystemConfig.getAppSettings().get("DataDirPath").toString();
		String path=str1 + str2 + File.separator + "Data" + File.separator;
		com.kong.kflowweb.BP.DA.Log.DebugWriteInfo(path);
		return path;
	}
	...
	public static String getCCFlowWebPath() {
		return com.kong.kflowweb.BP.WF.Glo.getCCFlowAppPath();
	}
	...
	public static String getPathOfWebApp() {
		...
		if (SystemConfig.getIsBSsystem()) {
			if (Glo.getRequest() == null || Glo.getRequest().getSession() == null) {
				return com.kong.kflowweb.BP.WF.Glo.getHostURL() + "/";
			} else {
	...
	public static String getPageOfAfterAuthorizeLogin() {
		/*
		 * warning return com.kong.kflowweb.BP.Glo.getHttpContextCurrent().Request.ApplicationPath
	 ...
	 * @return
	 */
	public static com.kong.kflowweb.BP.DA.DBType getAppCenterDBType() {
		...
		if (jdbcType != null) {
			...
			if (dbType.equalsIgnoreCase("MSMSSQL") || dbType.equalsIgnoreCase("MSSQL")) {
				return com.kong.kflowweb.BP.DA.DBType.MSSQL;
			} else if (dbType.equalsIgnoreCase("Oracle")) {
				return com.kong.kflowweb.BP.DA.DBType.Oracle;
			} else if (dbType.equalsIgnoreCase("MySQL")) {
				return com.kong.kflowweb.BP.DA.DBType.MySQL;
			}
		}
		if (jdbcType==null)
			jdbcType="";
		
		throw new RuntimeException("未知的数据库类型，请配置全局设置文件(jflow.properties/web.config ...)  AppCenterDBType 属性。"+jdbcType );
	}
	...
	public static String getAppCenterDBDatabase() {
		if (_AppCenterDBDatabase == null) {
			...
			/*
			 * warning switch (com.kong.kflowweb.BP.DA.DBAccess.getAppCenterDBType()){ case MSSQL:
	...
	public static void DoClearCash() {
		...
		com.kong.kflowweb.BP.DA.Cash.getMap_Cash().clear();
		com.kong.kflowweb.BP.DA.Cash.getSQL_Cash().clear();
		com.kong.kflowweb.BP.DA.Cash.getEnsData_Cash().clear();
		com.kong.kflowweb.BP.DA.Cash.getEnsData_Cash_Ext().clear();
		com.kong.kflowweb.BP.DA.Cash.getBS_Cash().clear();
		com.kong.kflowweb.BP.DA.Cash.getBill_Cash().clear();
