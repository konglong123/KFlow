...
public class FrmImg extends EntityMyPK
{
	...
	*/
	...
	public final String getImgPath()
	{
		...
		{
			src =  "DataUser/ICON/" + com.kong.kflowweb.BP.Sys.SystemConfig.getCustomerNo() + "/LogBiger.png";
		}
		return src;
	}
	...
	*/
	...
	public Map getEnMap()
	{
		if (this.get_enMap() != null)
		{
           ...
           //显示的分组.
           map.AddDDLSQL(MapAttrAttr.GroupID, 0, "显示的分组",com.kong.kflowweb.BP.Sys.FrmUI.MapAttrString.SQLOfGroupAttr(), true);
