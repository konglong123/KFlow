...
public class SFDBSrc extends EntityNoName
{
	...
	*/
	...
	{
		return com.kong.kflowweb.BP.DA.DBAccess.RunSQL(sql);
		/*int i = 0;
		switch (this.getDBSrcType())
		{
			case Localhost:
	...
	public final DataTable RunSQLReturnTable(String runObj, Paras ps)
	{
		...
		/*switch (this.getDBSrcType())
		{
			case Localhost: //如果是本机，直接在本机上执行.
				return com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(runObj, ps);
	...
	*/
	public final String getConnString()
	{
		...
		{
			case Localhost:
				return com.kong.kflowweb.BP.Sys.SystemConfig.getAppCenterDSN();
			case SQLServer:
	...
	*/
	public final String DoConn()
	{
		...
		if (this.getDBSrcType() == com.kong.kflowweb.BP.Sys.DBSrcType.Localhost)
		...
		String dsn = "";
		if (this.getDBSrcType() == com.kong.kflowweb.BP.Sys.DBSrcType.SQLServer)
		{
			try
			{
				...
				try
				{
					com.kong.kflowweb.BP.DA.DBAccess.RunSQL("Exec sp_droplinkedsrvlogin " + this.getNo() + ",Null ");
					com.kong.kflowweb.BP.DA.DBAccess.RunSQL("Exec sp_dropserver " + this.getNo());
				}
		...
		if (this.getDBSrcType() == com.kong.kflowweb.BP.Sys.DBSrcType.Oracle)
		{
			try
			{
		...
		if (this.getDBSrcType() == com.kong.kflowweb.BP.Sys.DBSrcType.MySQL)
		{
			try
			{
		...
		/*if (this.getDBSrcType() == com.kong.kflowweb.BP.Sys.DBSrcType.Informix)
		{
			try
			{
		...
		if (this.getDBSrcType() == com.kong.kflowweb.BP.Sys.DBSrcType.WebServices)
		{
...
//				dt.Rows.add(mydr);
	...
	*/
	/*private System.Data.Common.DbConnection GetConnection(String dsn)
	{
		...
		DBSrcType dbType = this.getDBSrcType();
		if (dbType == com.kong.kflowweb.BP.Sys.DBSrcType.Localhost)
		{
			switch (SystemConfig.getAppCenterDBType())
			{
				case MSSQL:
	...
	/*private DataTable RunSQLReturnTable(String sql, System.Data.Common.DbConnection conn, String dsn, CommandType cmdType)
	{
		...
		{
			return com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(sql, (System.Data.SqlClient.SqlConnection)conn, dsn, cmdType);
		}
		if (conn instanceof System.Data.OleDb.OleDbConnection)
		{
			return com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(sql, (System.Data.OleDb.OleDbConnection)conn, cmdType);
		}
		if (conn instanceof System.Data.OracleClient.OracleConnection)
		{
			return com.kong.kflowweb.BP.DA.DBAccess.RunSQLReturnTable(sql, (System.Data.OracleClient.OracleConnection)conn, cmdType, dsn);
		}
	...
	*/
	...
	{
		if (!this.getNo().equals("local") && this.getDBSrcType() == com.kong.kflowweb.BP.Sys.DBSrcType.Localhost)
		{
