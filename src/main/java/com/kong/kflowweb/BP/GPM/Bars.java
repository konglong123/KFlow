...
public class Bars extends EntitiesNoName {
	...
	public int RetrieveAll() throws Exception {
		// 初始化数据到，表里面去.
		ArrayList als = ClassFactory.GetObjects("com.kong.kflowweb.BP.GPM.BarBase");
		...
		for (Object item : als) {
			...
			barEmp.setMyPK(en.getNo() + "_" + com.kong.kflowweb.BP.Web.WebUser.getNo());
			int i = barEmp.RetrieveFromDBSources();

			barEmp.setFK_Bar(en.getNo());
			barEmp.setFK_Emp(com.kong.kflowweb.BP.Web.WebUser.getNo());
