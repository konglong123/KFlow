	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddSearchAttr(StationAttr.FK_StationType);
			...
			//岗位绑定菜单
		map.getAttrsOfOneVSM().AddBranches(new StationMenus(), new com.kong.kflowweb.BP.GPM.Menus(), com.kong.kflowweb.BP.GPM.StationMenuAttr.FK_Station, com.kong.kflowweb.BP.GPM.StationMenuAttr.FK_Menu, "绑定菜单", EmpAttr.Name, EmpAttr.No, "0");
