	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.getAttrsOfOneVSM().Add(new GroupEmps(), new Emps(), GroupEmpAttr.FK_Group, GroupEmpAttr.FK_Emp, EmpAttr.Name, EmpAttr.No, "人员(简单)");
			...
			//节点绑定人员. 使用树杆与叶子的模式绑定.
		map.getAttrsOfOneVSM().AddBranchesAndLeaf(new GroupEmps(), new com.kong.kflowweb.BP.Port.Emps(), GroupEmpAttr.FK_Group, GroupEmpAttr.FK_Emp, "人员(树)", EmpAttr.FK_Dept, EmpAttr.Name, EmpAttr.No, "@WebUser.FK_Dept");
		...
		map.getAttrsOfOneVSM().AddGroupListModel(new GroupStations(), new com.kong.kflowweb.BP.GPM.Stations(), GroupStationAttr.FK_Group, GroupStationAttr.FK_Station, "岗位(平铺)", StationAttr.FK_StationType,StationAttr.Name,StationAttr.No);


			//节点绑定部门. 节点绑定部门.
		map.getAttrsOfOneVSM().AddBranches(new GroupMenus(), new com.kong.kflowweb.BP.GPM.Menus(), com.kong.kflowweb.BP.GPM.GroupMenuAttr.FK_Group, com.kong.kflowweb.BP.GPM.GroupMenuAttr.FK_Menu, "绑定菜单", EmpAttr.Name, EmpAttr.No, "0");
